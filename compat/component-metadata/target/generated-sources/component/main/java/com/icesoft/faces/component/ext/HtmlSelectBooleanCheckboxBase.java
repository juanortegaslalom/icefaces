...
/**
 * A checkbox for a single, selectable option
 * <p>Auto-generated component class.
 * Do <strong>NOT</strong> modify; all changes
 * <strong>will</strong> be lost!</p>
 */

abstract class HtmlSelectBooleanCheckboxBase extends javax.faces.component.html.HtmlSelectBooleanCheckbox {

    /**
     * <p>Construct a new <code>HtmlSelectBooleanCheckboxBase</code>.</p>
     */
    public HtmlSelectBooleanCheckboxBase() {
        super();
 ...
 * 		set to display:none</p>
    ...
    public void restoreState(FacesContext _context,Object _state) {
        ...
        this.onchange = (String) _values[14];
        this.onclick = (String) _values[15];
        this.onclickeffect = (com.icesoft.faces.context.effects.Effect) _values[16];
        this.ondblclick = (String) _values[17];
        this.ondblclickeffect = (com.icesoft.faces.context.effects.Effect) _values[18];
        this.onfocus = (String) _values[19];
        ...
        this.partialSubmit = ((Boolean) _values[36]).booleanValue();
        this.partialSubmit_set = ((Boolean) _values[37]).booleanValue();
        this.readonly = ((Boolean) _values[38]).booleanValue();
        this.readonly_set = ((Boolean) _values[39]).booleanValue();
        this.rendered = ((Boolean) _values[40]).booleanValue();
        this.rendered_set = ((Boolean) _values[41]).booleanValue();
        this.renderedOnUserRole = (String) _values[42];
        this.required = ((Boolean) _values[43]).booleanValue();
        this.required_set = ((Boolean) _values[44]).booleanValue();
        this.requiredMessage = (String) _values[45];
        this.selected = ((Boolean) _values[46]).booleanValue();
        this.selected_set = ((Boolean) _values[47]).booleanValue();
        this.style = (String) _values[48];
        this.styleClass = (String) _values[49];
        this.tabindex = (String) _values[50];
        this.title = (String) _values[51];
        this.validator = (javax.faces.el.MethodBinding) restoreAttachedState(_context, _values[52]);
        this.value = (Object) _values[53];
        this.valueChangeListener = (javax.faces.el.MethodBinding) restoreAttachedState(_context, _values[54]);
    ...
    public Object saveState(FacesContext _context) {
        ...
        _values[14] = this.onchange;
        _values[15] = this.onclick;
        _values[16] = this.onclickeffect;
        _values[17] = this.ondblclick;
        _values[18] = this.ondblclickeffect;
        _values[19] = this.onfocus;
        ...
        _values[36] = this.partialSubmit ? Boolean.TRUE : Boolean.FALSE;
        _values[37] = this.partialSubmit_set ? Boolean.TRUE : Boolean.FALSE;
        _values[38] = this.readonly ? Boolean.TRUE : Boolean.FALSE;
        _values[39] = this.readonly_set ? Boolean.TRUE : Boolean.FALSE;
        _values[40] = this.rendered ? Boolean.TRUE : Boolean.FALSE;
        _values[41] = this.rendered_set ? Boolean.TRUE : Boolean.FALSE;
        _values[42] = this.renderedOnUserRole;
        _values[43] = this.required ? Boolean.TRUE : Boolean.FALSE;
        _values[44] = this.required_set ? Boolean.TRUE : Boolean.FALSE;
        _values[45] = this.requiredMessage;
        _values[46] = this.selected ? Boolean.TRUE : Boolean.FALSE;
        _values[47] = this.selected_set ? Boolean.TRUE : Boolean.FALSE;
        _values[48] = this.style;
        _values[49] = this.styleClass;
        _values[50] = this.tabindex;
        _values[51] = this.title;
        _values[52] = saveAttachedState(_context, validator);
        _values[53] = this.value;
        _values[54] = saveAttachedState(_context, valueChangeListener);
