...
abstract class HtmlInputTextBase extends javax.faces.component.html.HtmlInputText {

    /**
     * <p>Construct a new <code>HtmlInputTextBase</code>.</p>
     */
    public HtmlInputTextBase() {
        super();
 ...
 * 		if enabled and <b>iceInpTxt-dis</b> if disabled.</p>
     */
 ...
 * 		set to display:none</p>
    ...
    public void restoreState(FacesContext _context,Object _state) {
        ...
        this.size = ((Integer) _values[51]).intValue();
        this.size_set = ((Boolean) _values[52]).booleanValue();
        this.style = (String) _values[53];
        this.styleClass = (String) _values[54];
        this.tabindex = (String) _values[55];
        this.title = (String) _values[56];
        this.validator = (javax.faces.el.MethodBinding) restoreAttachedState(_context, _values[57]);
        this.value = (Object) _values[58];
        this.valueChangeListener = (javax.faces.el.MethodBinding) restoreAttachedState(_context, _values[59]);
        this.visible = ((Boolean) _values[60]).booleanValue();
        this.visible_set = ((Boolean) _values[61]).booleanValue();
    }
    ...
    public Object saveState(FacesContext _context) {
        ...
        _values[51] = new Integer(this.size);
        _values[52] = this.size_set ? Boolean.TRUE : Boolean.FALSE;
        _values[53] = this.style;
        _values[54] = this.styleClass;
        _values[55] = this.tabindex;
        _values[56] = this.title;
        _values[57] = saveAttachedState(_context, validator);
        _values[58] = this.value;
        _values[59] = saveAttachedState(_context, valueChangeListener);
        _values[60] = this.visible ? Boolean.TRUE : Boolean.FALSE;
        _values[61] = this.visible_set ? Boolean.TRUE : Boolean.FALSE;
        return _values;
    }
