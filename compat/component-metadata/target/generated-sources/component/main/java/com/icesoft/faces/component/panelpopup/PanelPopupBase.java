...
/**
 * Provides a moveable or modal popup panel that hovers on top of
 * 		the page
...
abstract class PanelPopupBase extends javax.faces.component.UIPanel {

    /**
     * <p>Construct a new <code>PanelPopupBase</code>.</p>
     */
    public PanelPopupBase() {
        super();
 ...
 * 		and window resizing events.</p>
    ...
    /**
 * <p>Used to keep the popup positioned on the screen through
 ...
 *         positions by style or styleClass.</p>
     */
    public String getAutoPosition() {
        if (this.autoPosition != null) {
            return this.autoPosition;
        }
        ValueBinding _vb = getValueBinding("autoPosition");
        if (_vb != null) {
 ...
 *         positions by style or styleClass.</p>
    ...
    /**
 * <p>Sends update to the server on drop event if false.
 ...
 *   			container.</p>
    ...
    private boolean modal_set = false;

    /**
 * <p>Used to render a modal popup. Note: this will only cover the
 * 		body of a document. Make sure the document body takes up 100% of
 * 		the window. For example: <html><body><div
 * 		style="height=100%;witdh:100%;"><div></body></html></p>
     */
    public boolean isModal() {
        if (this.modal_set) {
            return this.modal;
        }
        ValueBinding _vb = getValueBinding("modal");
        if (_vb != null) {
            Object _result = _vb.getValue(getFacesContext());
            if (_result == null) {
                return false;
 ...
 * <p>Effect invoked on onmouseup event</p>
    ...
    // positionOnLoadOnly
    private boolean positionOnLoadOnly = false;
    private boolean positionOnLoadOnly_set = false;

    /**
 * <p>Centre or position popup once on load only. Any drag and drop or scroll will disable autoCentre and autoPosition.</p>
     */
    public boolean isPositionOnLoadOnly() {
        if (this.positionOnLoadOnly_set) {
            return this.positionOnLoadOnly;
        }
        ValueBinding _vb = getValueBinding("positionOnLoadOnly");
        if (_vb != null) {
            Object _result = _vb.getValue(getFacesContext());
            if (_result == null) {
                return false;
 ...
 * 		will be skipped.</p>
    ...
    /**
 * <p>This attribute is currently unsupported.</p>
     */
 ...
 * 		set to display:none</p>
    ...
    public void restoreState(FacesContext _context,Object _state) {
        ...
        this.autoCentre = ((Boolean) _values[1]).booleanValue();
        this.autoCentre_set = ((Boolean) _values[2]).booleanValue();
        this.autoPosition = (String) _values[3];
        this.clientOnly = ((Boolean) _values[4]).booleanValue();
        this.clientOnly_set = ((Boolean) _values[5]).booleanValue();
        this.draggable = (String) _values[6];
        this.effect = (com.icesoft.faces.context.effects.Effect) _values[7];
        this.id = (String) _values[8];
        this.modal = ((Boolean) _values[9]).booleanValue();
        this.modal_set = ((Boolean) _values[10]).booleanValue();
        ...
        this.positionOnLoadOnly = ((Boolean) _values[31]).booleanValue();
        this.positionOnLoadOnly_set = ((Boolean) _values[32]).booleanValue();
        this.rendered = ((Boolean) _values[33]).booleanValue();
        this.rendered_set = ((Boolean) _values[34]).booleanValue();
        this.renderedOnUserRole = (String) _values[35];
        this.resizable = ((Boolean) _values[36]).booleanValue();
        this.resizable_set = ((Boolean) _values[37]).booleanValue();
        this.style = (String) _values[38];
        this.styleClass = (String) _values[39];
        this.title = (String) _values[40];
        this.visible = ((Boolean) _values[41]).booleanValue();
        this.visible_set = ((Boolean) _values[42]).booleanValue();
    }
    ...
    public Object saveState(FacesContext _context) {
        ...
        _values[1] = this.autoCentre ? Boolean.TRUE : Boolean.FALSE;
        _values[2] = this.autoCentre_set ? Boolean.TRUE : Boolean.FALSE;
        _values[3] = this.autoPosition;
        _values[4] = this.clientOnly ? Boolean.TRUE : Boolean.FALSE;
        _values[5] = this.clientOnly_set ? Boolean.TRUE : Boolean.FALSE;
        _values[6] = this.draggable;
        _values[7] = this.effect;
        _values[8] = this.id;
        _values[9] = this.modal ? Boolean.TRUE : Boolean.FALSE;
        _values[10] = this.modal_set ? Boolean.TRUE : Boolean.FALSE;
        ...
        _values[31] = this.positionOnLoadOnly ? Boolean.TRUE : Boolean.FALSE;
        _values[32] = this.positionOnLoadOnly_set ? Boolean.TRUE : Boolean.FALSE;
        _values[33] = this.rendered ? Boolean.TRUE : Boolean.FALSE;
        _values[34] = this.rendered_set ? Boolean.TRUE : Boolean.FALSE;
        _values[35] = this.renderedOnUserRole;
        _values[36] = this.resizable ? Boolean.TRUE : Boolean.FALSE;
        _values[37] = this.resizable_set ? Boolean.TRUE : Boolean.FALSE;
        _values[38] = this.style;
        _values[39] = this.styleClass;
        _values[40] = this.title;
        _values[41] = this.visible ? Boolean.TRUE : Boolean.FALSE;
        _values[42] = this.visible_set ? Boolean.TRUE : Boolean.FALSE;
        return _values;
    }
