...
/**
 * A hyperlink that can Submit a form
 * <p>Auto-generated component class.
 * Do <strong>NOT</strong> modify; all changes
 * <strong>will</strong> be lost!</p>
 */

abstract class HtmlCommandLinkBase extends javax.faces.component.html.HtmlCommandLink {

    /**
     * <p>Construct a new <code>HtmlCommandLinkBase</code>.</p>
     */
    public HtmlCommandLinkBase() {
        super();
 ...
 * <p>Effect invoked on onmouseup event</p>
    ...
    /**
 * <p>The id of the ice:panelConfirmation component associated to this link.</p>
     */
 ...
 * <p>CSS style(s) to be applied when this component is rendered.</p>
    ...
    /**
 * <p>The base name for all style classes. Default value is <b>iceCmdLnk</b> if enabled
 * 		and <b>iceCmdLnk-dis</b> if disabled.</p>
     */
 ...
 * 		set to display:none</p>
    ...
    public void restoreState(FacesContext _context,Object _state) {
        ...
        this.charset = (String) _values[4];
        this.coords = (String) _values[5];
        ...
        this.hreflang = (String) _values[11];
        ...
        this.panelConfirmation = (String) _values[38];
        this.partialSubmit = ((Boolean) _values[39]).booleanValue();
        this.partialSubmit_set = ((Boolean) _values[40]).booleanValue();
        this.rel = (String) _values[41];
        this.rendered = ((Boolean) _values[42]).booleanValue();
        this.rendered_set = ((Boolean) _values[43]).booleanValue();
        this.renderedOnUserRole = (String) _values[44];
        this.rev = (String) _values[45];
        this.shape = (String) _values[46];
        this.style = (String) _values[47];
        this.styleClass = (String) _values[48];
        this.tabindex = (String) _values[49];
        this.target = (String) _values[50];
        this.title = (String) _values[51];
        this.type = (String) _values[52];
        this.value = (Object) _values[53];
        this.visible = ((Boolean) _values[54]).booleanValue();
        this.visible_set = ((Boolean) _values[55]).booleanValue();
    }
    ...
    public Object saveState(FacesContext _context) {
        ...
        _values[4] = this.charset;
        _values[5] = this.coords;
        _values[6] = this.dir;
        ...
        _values[38] = this.panelConfirmation;
        _values[39] = this.partialSubmit ? Boolean.TRUE : Boolean.FALSE;
        _values[40] = this.partialSubmit_set ? Boolean.TRUE : Boolean.FALSE;
        _values[41] = this.rel;
        _values[42] = this.rendered ? Boolean.TRUE : Boolean.FALSE;
        _values[43] = this.rendered_set ? Boolean.TRUE : Boolean.FALSE;
        _values[44] = this.renderedOnUserRole;
        _values[45] = this.rev;
        _values[46] = this.shape;
        _values[47] = this.style;
        _values[48] = this.styleClass;
        _values[49] = this.tabindex;
        _values[50] = this.target;
        _values[51] = this.title;
        _values[52] = this.type;
        _values[53] = this.value;
        _values[54] = this.visible ? Boolean.TRUE : Boolean.FALSE;
        _values[55] = this.visible_set ? Boolean.TRUE : Boolean.FALSE;
        return _values;
    }
