...
/**
 * A single-choice control represented as a radio button.
 * <p>Auto-generated component class.
 * Do <strong>NOT</strong> modify; all changes
 * <strong>will</strong> be lost!</p>
 */

abstract class HtmlRadioBase extends javax.faces.component.UIComponentBase {

    /**
     * <p>Construct a new <code>HtmlRadioBase</code>.</p>
     */
    public HtmlRadioBase() {
        super();
    ...
    /**
 * <p>ID of the selectOneRadio component to which this radio button belongs.</p>
     */
 ...
 *   			container.</p>
    ...
    /**
 * <p>Index of the SelectItem mapped to this radio button, starting with zero.</p>
     */
    public int getIndex() {
        if (this.index_set) {
            return this.index;
