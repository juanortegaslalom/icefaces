...
/**
 * An input field that hides user input from the user
 * <p>Auto-generated component class.
 * Do <strong>NOT</strong> modify; all changes
 * <strong>will</strong> be lost!</p>
 */

abstract class HtmlInputSecretBase extends javax.faces.component.html.HtmlInputText {

    /**
     * <p>Construct a new <code>HtmlInputSecretBase</code>.</p>
     */
    public HtmlInputSecretBase() {
        super();
        setRendererType("com.icesoft.faces.Secret");
    }
 ...
 *         non-functional for other input types like "radio" or "checkbox".</p>
    ...
    /**
 * <p>Flag indicating that any existing value in this field should be
 * 			rendered when the form is created. Because this is a potential
 * 			security risk, password values are not displayed by default.</p>
     */
 ...
 * <p>CSS style(s) to be applied when this component is rendered.</p>
    ...
    /**
 * <p>The base name for all style classes. Default value is <b>iceInpSecrt</b> if 
 * 		enabled and <b>iceInpSecrt-dis</b> if disabled.</p>
     */
 ...
 * 		set to display:none</p>
    ...
    public void restoreState(FacesContext _context,Object _state) {
        ...
        this.maxlength = ((Integer) _values[16]).intValue();
        this.maxlength_set = ((Boolean) _values[17]).booleanValue();
        ...
        this.onselect = (String) _values[40];
        ...
        this.redisplay = ((Boolean) _values[45]).booleanValue();
        this.redisplay_set = ((Boolean) _values[46]).booleanValue();
        this.rendered = ((Boolean) _values[47]).booleanValue();
        this.rendered_set = ((Boolean) _values[48]).booleanValue();
        this.renderedOnUserRole = (String) _values[49];
        this.required = ((Boolean) _values[50]).booleanValue();
        this.required_set = ((Boolean) _values[51]).booleanValue();
        this.requiredMessage = (String) _values[52];
        this.size = ((Integer) _values[53]).intValue();
        this.size_set = ((Boolean) _values[54]).booleanValue();
        this.style = (String) _values[55];
        this.styleClass = (String) _values[56];
        this.tabindex = (String) _values[57];
        this.title = (String) _values[58];
        this.validator = (javax.faces.el.MethodBinding) restoreAttachedState(_context, _values[59]);
        this.value = (Object) _values[60];
        this.valueChangeListener = (javax.faces.el.MethodBinding) restoreAttachedState(_context, _values[61]);
        this.visible = ((Boolean) _values[62]).booleanValue();
        this.visible_set = ((Boolean) _values[63]).booleanValue();
    }
    ...
    public Object saveState(FacesContext _context) {
        ...
        _values[16] = new Integer(this.maxlength);
        _values[17] = this.maxlength_set ? Boolean.TRUE : Boolean.FALSE;
        ...
        _values[45] = this.redisplay ? Boolean.TRUE : Boolean.FALSE;
        _values[46] = this.redisplay_set ? Boolean.TRUE : Boolean.FALSE;
        _values[47] = this.rendered ? Boolean.TRUE : Boolean.FALSE;
        _values[48] = this.rendered_set ? Boolean.TRUE : Boolean.FALSE;
        _values[49] = this.renderedOnUserRole;
        _values[50] = this.required ? Boolean.TRUE : Boolean.FALSE;
        _values[51] = this.required_set ? Boolean.TRUE : Boolean.FALSE;
        _values[52] = this.requiredMessage;
        _values[53] = new Integer(this.size);
        _values[54] = this.size_set ? Boolean.TRUE : Boolean.FALSE;
        _values[55] = this.style;
        _values[56] = this.styleClass;
        _values[57] = this.tabindex;
        _values[58] = this.title;
        _values[59] = saveAttachedState(_context, validator);
        _values[60] = this.value;
        _values[61] = saveAttachedState(_context, valueChangeListener);
        _values[62] = this.visible ? Boolean.TRUE : Boolean.FALSE;
        _values[63] = this.visible_set ? Boolean.TRUE : Boolean.FALSE;
        return _values;
    }
