...
/**
 * A multiple-choice control represented as checkboxes
 * <p>Auto-generated component class.
 * Do <strong>NOT</strong> modify; all changes
 * <strong>will</strong> be lost!</p>
 */

abstract class HtmlSelectManyCheckboxBase extends javax.faces.component.html.HtmlSelectManyCheckbox {

    /**
     * <p>Construct a new <code>HtmlSelectManyCheckboxBase</code>.</p>
     */
    public HtmlSelectManyCheckboxBase() {
        super();
 ...
 * 		set to display:none</p>
    ...
    public void restoreState(FacesContext _context,Object _state) {
        ...
        this.converter = (javax.faces.convert.Converter) _values[5];
        this.dir = (String) _values[6];
        this.disabled = ((Boolean) _values[7]).booleanValue();
        this.disabled_set = ((Boolean) _values[8]).booleanValue();
        this.disabledClass = (String) _values[9];
        this.effect = (com.icesoft.faces.context.effects.Effect) _values[10];
        this.enabledClass = (String) _values[11];
        this.enabledOnUserRole = (String) _values[12];
        this.id = (String) _values[13];
        this.immediate = ((Boolean) _values[14]).booleanValue();
        this.immediate_set = ((Boolean) _values[15]).booleanValue();
        this.lang = (String) _values[16];
        this.layout = (String) _values[17];
        this.onblur = (String) _values[18];
        this.onchange = (String) _values[19];
        this.onclick = (String) _values[20];
        this.onclickeffect = (com.icesoft.faces.context.effects.Effect) _values[21];
        this.ondblclick = (String) _values[22];
        this.ondblclickeffect = (com.icesoft.faces.context.effects.Effect) _values[23];
        this.onfocus = (String) _values[24];
        this.onkeydown = (String) _values[25];
        this.onkeydowneffect = (com.icesoft.faces.context.effects.Effect) _values[26];
        this.onkeypress = (String) _values[27];
        this.onkeypresseffect = (com.icesoft.faces.context.effects.Effect) _values[28];
        this.onkeyup = (String) _values[29];
        this.onkeyupeffect = (com.icesoft.faces.context.effects.Effect) _values[30];
        this.onmousedown = (String) _values[31];
        this.onmousedowneffect = (com.icesoft.faces.context.effects.Effect) _values[32];
        this.onmousemove = (String) _values[33];
        this.onmousemoveeffect = (com.icesoft.faces.context.effects.Effect) _values[34];
        this.onmouseout = (String) _values[35];
        this.onmouseouteffect = (com.icesoft.faces.context.effects.Effect) _values[36];
        this.onmouseover = (String) _values[37];
        this.onmouseovereffect = (com.icesoft.faces.context.effects.Effect) _values[38];
        this.onmouseup = (String) _values[39];
        this.onmouseupeffect = (com.icesoft.faces.context.effects.Effect) _values[40];
        this.partialSubmit = ((Boolean) _values[41]).booleanValue();
        this.partialSubmit_set = ((Boolean) _values[42]).booleanValue();
        this.readonly = ((Boolean) _values[43]).booleanValue();
        this.readonly_set = ((Boolean) _values[44]).booleanValue();
        this.rendered = ((Boolean) _values[45]).booleanValue();
        this.rendered_set = ((Boolean) _values[46]).booleanValue();
        this.renderedOnUserRole = (String) _values[47];
        this.required = ((Boolean) _values[48]).booleanValue();
        this.required_set = ((Boolean) _values[49]).booleanValue();
        this.requiredMessage = (String) _values[50];
        this.style = (String) _values[51];
        this.styleClass = (String) _values[52];
        this.tabindex = (String) _values[53];
        this.title = (String) _values[54];
        this.validator = (javax.faces.el.MethodBinding) restoreAttachedState(_context, _values[55]);
        this.value = (Object) _values[56];
        this.valueChangeListener = (javax.faces.el.MethodBinding) restoreAttachedState(_context, _values[57]);
        this.visible = ((Boolean) _values[58]).booleanValue();
        this.visible_set = ((Boolean) _values[59]).booleanValue();
    }
    ...
    public Object saveState(FacesContext _context) {
        ...
        _values[5] = this.converter;
        _values[6] = this.dir;
        _values[7] = this.disabled ? Boolean.TRUE : Boolean.FALSE;
        _values[8] = this.disabled_set ? Boolean.TRUE : Boolean.FALSE;
        _values[9] = this.disabledClass;
        _values[10] = this.effect;
        _values[11] = this.enabledClass;
        _values[12] = this.enabledOnUserRole;
        _values[13] = this.id;
        _values[14] = this.immediate ? Boolean.TRUE : Boolean.FALSE;
        _values[15] = this.immediate_set ? Boolean.TRUE : Boolean.FALSE;
        _values[16] = this.lang;
        _values[17] = this.layout;
        _values[18] = this.onblur;
        _values[19] = this.onchange;
        _values[20] = this.onclick;
        _values[21] = this.onclickeffect;
        _values[22] = this.ondblclick;
        _values[23] = this.ondblclickeffect;
        _values[24] = this.onfocus;
        _values[25] = this.onkeydown;
        _values[26] = this.onkeydowneffect;
        _values[27] = this.onkeypress;
        _values[28] = this.onkeypresseffect;
        _values[29] = this.onkeyup;
        _values[30] = this.onkeyupeffect;
        _values[31] = this.onmousedown;
        _values[32] = this.onmousedowneffect;
        _values[33] = this.onmousemove;
        _values[34] = this.onmousemoveeffect;
        _values[35] = this.onmouseout;
        _values[36] = this.onmouseouteffect;
        _values[37] = this.onmouseover;
        _values[38] = this.onmouseovereffect;
        _values[39] = this.onmouseup;
        _values[40] = this.onmouseupeffect;
        _values[41] = this.partialSubmit ? Boolean.TRUE : Boolean.FALSE;
        _values[42] = this.partialSubmit_set ? Boolean.TRUE : Boolean.FALSE;
        _values[43] = this.readonly ? Boolean.TRUE : Boolean.FALSE;
        _values[44] = this.readonly_set ? Boolean.TRUE : Boolean.FALSE;
        _values[45] = this.rendered ? Boolean.TRUE : Boolean.FALSE;
        _values[46] = this.rendered_set ? Boolean.TRUE : Boolean.FALSE;
        _values[47] = this.renderedOnUserRole;
        _values[48] = this.required ? Boolean.TRUE : Boolean.FALSE;
        _values[49] = this.required_set ? Boolean.TRUE : Boolean.FALSE;
        _values[50] = this.requiredMessage;
        _values[51] = this.style;
        _values[52] = this.styleClass;
        _values[53] = this.tabindex;
        _values[54] = this.title;
        _values[55] = saveAttachedState(_context, validator);
        _values[56] = this.value;
        _values[57] = saveAttachedState(_context, valueChangeListener);
        _values[58] = this.visible ? Boolean.TRUE : Boolean.FALSE;
        _values[59] = this.visible_set ? Boolean.TRUE : Boolean.FALSE;
        return _values;
    }
