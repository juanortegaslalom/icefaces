...
/**
 * A multiple-choice listbox
 * <p>Auto-generated component class.
 * Do <strong>NOT</strong> modify; all changes
 * <strong>will</strong> be lost!</p>
 */

abstract class HtmlSelectManyListboxBase extends javax.faces.component.html.HtmlSelectManyListbox {

    /**
     * <p>Construct a new <code>HtmlSelectManyListboxBase</code>.</p>
     */
    public HtmlSelectManyListboxBase() {
        super();
        setRendererType("com.icesoft.faces.Listbox");
    }
 ...
 * <p>Enable component to perform partial submit. Default value is false.</p>
    ...
    // partialSubmitDelay
    private int partialSubmitDelay = Integer.MIN_VALUE;
    private boolean partialSubmitDelay_set = false;

    /**
 * <p>When partialSubmit=true, partialSubmitDelay is the number of 
 ...
 *         use -1.</p>
    ...
    public int getPartialSubmitDelay() {
        if (this.partialSubmitDelay_set) {
            return this.partialSubmitDelay;
        }
        ValueBinding _vb = getValueBinding("partialSubmitDelay");
        if (_vb != null) {
            Object _result = _vb.getValue(getFacesContext());
            if (_result == null) {
 ...
 *         navigation. Default value is 300 milliseconds. To disable the delay,
 *         use -1.</p>
     * @see #getPartialSubmitDelay()
     */
    public void setPartialSubmitDelay(int partialSubmitDelay) {
        this.partialSubmitDelay = partialSubmitDelay;
        this.partialSubmitDelay_set = true;
    }

    // partialSubmitOnBlur
    private boolean partialSubmitOnBlur = false;
    private boolean partialSubmitOnBlur_set = false;

    /**
 * <p>When this attribute is set to 'true', partial submit (if enabled) will occur only when blurring the field. Otherwise, it will occur whenever a different value is selected in the listbox (either with the mouse or the keyboard). Default value is false.</p>
     */
    public boolean isPartialSubmitOnBlur() {
        if (this.partialSubmitOnBlur_set) {
            return this.partialSubmitOnBlur;
        }
        ValueBinding _vb = getValueBinding("partialSubmitOnBlur");
        if (_vb != null) {
            Object _result = _vb.getValue(getFacesContext());
            if (_result == null) {
                return false;
    ...
    /**
 * <p>When this attribute is set to 'true', partial submit (if enabled) will occur only when blurring the field. Otherwise, it will occur whenever a different value is selected in the listbox (either with the mouse or the keyboard). Default value is false.</p>
     * @see #isPartialSubmitOnBlur()
     */
    public void setPartialSubmitOnBlur(boolean partialSubmitOnBlur) {
        this.partialSubmitOnBlur = partialSubmitOnBlur;
        this.partialSubmitOnBlur_set = true;
    }
 ...
 * <p>A ValueExpression enabled attribute that, if present, will be used as the text of the validation message for the "required" facility, if the "required" facility is used.</p>
    ...
    /**
 * <p>Number of available options to be shown at all times. If not specified, 
 * 		all available options are shown.</p>
     */
    public int getSize() {
        if (this.size_set) {
            return this.size;
 ...
 * 		set to display:none</p>
    ...
    public void restoreState(FacesContext _context,Object _state) {
        ...
        this.partialSubmit = ((Boolean) _values[38]).booleanValue();
        this.partialSubmit_set = ((Boolean) _values[39]).booleanValue();
        this.partialSubmitDelay = ((Integer) _values[40]).intValue();
        this.partialSubmitDelay_set = ((Boolean) _values[41]).booleanValue();
        this.partialSubmitOnBlur = ((Boolean) _values[42]).booleanValue();
        this.partialSubmitOnBlur_set = ((Boolean) _values[43]).booleanValue();
        this.readonly = ((Boolean) _values[44]).booleanValue();
        this.readonly_set = ((Boolean) _values[45]).booleanValue();
        this.rendered = ((Boolean) _values[46]).booleanValue();
        this.rendered_set = ((Boolean) _values[47]).booleanValue();
        this.renderedOnUserRole = (String) _values[48];
        this.required = ((Boolean) _values[49]).booleanValue();
        this.required_set = ((Boolean) _values[50]).booleanValue();
        this.requiredMessage = (String) _values[51];
        this.size = ((Integer) _values[52]).intValue();
        this.size_set = ((Boolean) _values[53]).booleanValue();
        this.style = (String) _values[54];
        this.styleClass = (String) _values[55];
        this.tabindex = (String) _values[56];
        this.title = (String) _values[57];
        this.validator = (javax.faces.el.MethodBinding) restoreAttachedState(_context, _values[58]);
        this.value = (Object) _values[59];
        this.valueChangeListener = (javax.faces.el.MethodBinding) restoreAttachedState(_context, _values[60]);
        this.visible = ((Boolean) _values[61]).booleanValue();
        this.visible_set = ((Boolean) _values[62]).booleanValue();
    }
    ...
    public Object saveState(FacesContext _context) {
        ...
        _values[38] = this.partialSubmit ? Boolean.TRUE : Boolean.FALSE;
        _values[39] = this.partialSubmit_set ? Boolean.TRUE : Boolean.FALSE;
        _values[40] = new Integer(this.partialSubmitDelay);
        _values[41] = this.partialSubmitDelay_set ? Boolean.TRUE : Boolean.FALSE;
        _values[42] = this.partialSubmitOnBlur ? Boolean.TRUE : Boolean.FALSE;
        _values[43] = this.partialSubmitOnBlur_set ? Boolean.TRUE : Boolean.FALSE;
        _values[44] = this.readonly ? Boolean.TRUE : Boolean.FALSE;
        _values[45] = this.readonly_set ? Boolean.TRUE : Boolean.FALSE;
        _values[46] = this.rendered ? Boolean.TRUE : Boolean.FALSE;
        _values[47] = this.rendered_set ? Boolean.TRUE : Boolean.FALSE;
        _values[48] = this.renderedOnUserRole;
        _values[49] = this.required ? Boolean.TRUE : Boolean.FALSE;
        _values[50] = this.required_set ? Boolean.TRUE : Boolean.FALSE;
        _values[51] = this.requiredMessage;
        _values[52] = new Integer(this.size);
        _values[53] = this.size_set ? Boolean.TRUE : Boolean.FALSE;
        _values[54] = this.style;
        _values[55] = this.styleClass;
        _values[56] = this.tabindex;
        _values[57] = this.title;
        _values[58] = saveAttachedState(_context, validator);
        _values[59] = this.value;
        _values[60] = saveAttachedState(_context, valueChangeListener);
        _values[61] = this.visible ? Boolean.TRUE : Boolean.FALSE;
        _values[62] = this.visible_set ? Boolean.TRUE : Boolean.FALSE;
        return _values;
    }
