...
/**
 * An auto-completing text input control
 * <p>Auto-generated component class.
 * Do <strong>NOT</strong> modify; all changes
 * <strong>will</strong> be lost!</p>
 */

abstract class SelectInputTextBase extends javax.faces.component.html.HtmlInputText {

    /**
     * <p>Construct a new <code>SelectInputTextBase</code>.</p>
     */
    public SelectInputTextBase() {
        super();
 ...
 * 		component.</p>
    ...
    // listValue
    private java.util.List listValue = null;

    /**
 * <p>The list of selectItem components.</p>
     */
    public java.util.List getListValue() {
        if (this.listValue != null) {
            return this.listValue;
        }
        ValueBinding _vb = getValueBinding("listValue");
        if (_vb != null) {
            return (java.util.List) _vb.getValue(getFacesContext());
        }
        return null;
    }
 ...
 * 		exposed.</p>
    ...
    public String getListVar() {
        ...
        ValueBinding _vb = getValueBinding("listVar");
        if (_vb != null) {
            return (String) _vb.getValue(getFacesContext());
        }
        return null;
 ...
 * 		available rows in the underlying data model will be displayed.</p>
    ...
    /**
 * <p>The number of characters used to determine the width of this field.</p>
     */
    public int getSize() {
        if (this.size_set) {
            return this.size;
 ...
 * 		This value must be an integer between 0 and 32767.</p>
    ...
    // textChangeListener
    private javax.faces.el.MethodBinding textChangeListener = null;
 ...
 * 		which would be known to fail validation.</p>
    ...
    public javax.faces.el.MethodBinding getTextChangeListener() {
        ...
        ValueBinding _vb = getValueBinding("textChangeListener");
        if (_vb != null) {
            return (javax.faces.el.MethodBinding) _vb.getValue(getFacesContext());
        }
        return null;
 ...
 * 		and keep validation from happenning, on partially inputted text 
 * 		which would be known to fail validation.</p>
     * @see #getTextChangeListener()
     */
    public void setTextChangeListener(javax.faces.el.MethodBinding textChangeListener) {
 ...
 * 		set to display:none</p>
    ...
    /**
 * <p>Sets the width of both, inputText and associated drop down list.</p>
     */
 ...
 * <p>Sets the width of both, inputText and associated drop down list.</p>
    ...
    public void restoreState(FacesContext _context,Object _state) {
        ...
        this.converter = (javax.faces.convert.Converter) _values[6];
        this.dir = (String) _values[7];
        this.disabled = ((Boolean) _values[8]).booleanValue();
        this.disabled_set = ((Boolean) _values[9]).booleanValue();
        this.effect = (com.icesoft.faces.context.effects.Effect) _values[10];
        this.enabledOnUserRole = (String) _values[11];
        ...
        this.lang = (String) _values[15];
        this.listValue = (java.util.List) _values[16];
        this.listVar = (String) _values[17];
        this.maxlength = ((Integer) _values[18]).intValue();
        this.maxlength_set = ((Boolean) _values[19]).booleanValue();
        this.onchange = (String) _values[20];
        this.onclick = (String) _values[21];
        this.onclickeffect = (com.icesoft.faces.context.effects.Effect) _values[22];
        this.ondblclick = (String) _values[23];
        this.ondblclickeffect = (com.icesoft.faces.context.effects.Effect) _values[24];
        this.onfocus = (String) _values[25];
        this.onkeydown = (String) _values[26];
        this.onkeydowneffect = (com.icesoft.faces.context.effects.Effect) _values[27];
        this.onkeypress = (String) _values[28];
        this.onkeypresseffect = (com.icesoft.faces.context.effects.Effect) _values[29];
        this.onkeyup = (String) _values[30];
        this.onkeyupeffect = (com.icesoft.faces.context.effects.Effect) _values[31];
        this.onmousedown = (String) _values[32];
        this.onmousedowneffect = (com.icesoft.faces.context.effects.Effect) _values[33];
        this.onmousemove = (String) _values[34];
        this.onmousemoveeffect = (com.icesoft.faces.context.effects.Effect) _values[35];
        this.onmouseout = (String) _values[36];
        this.onmouseouteffect = (com.icesoft.faces.context.effects.Effect) _values[37];
        this.onmouseover = (String) _values[38];
        this.onmouseovereffect = (com.icesoft.faces.context.effects.Effect) _values[39];
        this.onmouseup = (String) _values[40];
        this.onmouseupeffect = (com.icesoft.faces.context.effects.Effect) _values[41];
        this.onselect = (String) _values[42];
        this.options = (String) _values[43];
        this.partialSubmit = ((Boolean) _values[44]).booleanValue();
        this.partialSubmit_set = ((Boolean) _values[45]).booleanValue();
        this.readonly = ((Boolean) _values[46]).booleanValue();
        this.readonly_set = ((Boolean) _values[47]).booleanValue();
        this.rendered = ((Boolean) _values[48]).booleanValue();
        this.rendered_set = ((Boolean) _values[49]).booleanValue();
        this.renderedOnUserRole = (String) _values[50];
        this.required = ((Boolean) _values[51]).booleanValue();
        this.required_set = ((Boolean) _values[52]).booleanValue();
        this.requiredMessage = (String) _values[53];
        this.rows = ((Integer) _values[54]).intValue();
        this.rows_set = ((Boolean) _values[55]).booleanValue();
        this.size = ((Integer) _values[56]).intValue();
        this.size_set = ((Boolean) _values[57]).booleanValue();
        this.style = (String) _values[58];
        this.styleClass = (String) _values[59];
        this.tabindex = (String) _values[60];
        this.textChangeListener = (javax.faces.el.MethodBinding) restoreAttachedState(_context, _values[61]);
        this.title = (String) _values[62];
        this.validator = (javax.faces.el.MethodBinding) restoreAttachedState(_context, _values[63]);
        this.value = (Object) _values[64];
        this.valueChangeListener = (javax.faces.el.MethodBinding) restoreAttachedState(_context, _values[65]);
        this.visible = ((Boolean) _values[66]).booleanValue();
        this.visible_set = ((Boolean) _values[67]).booleanValue();
        this.width = (String) _values[68];
    }
    ...
    public Object saveState(FacesContext _context) {
        ...
        _values[6] = this.converter;
        _values[7] = this.dir;
        _values[8] = this.disabled ? Boolean.TRUE : Boolean.FALSE;
        _values[9] = this.disabled_set ? Boolean.TRUE : Boolean.FALSE;
        _values[10] = this.effect;
        _values[11] = this.enabledOnUserRole;
        _values[12] = this.id;
        _values[13] = this.immediate ? Boolean.TRUE : Boolean.FALSE;
        _values[14] = this.immediate_set ? Boolean.TRUE : Boolean.FALSE;
        _values[15] = this.lang;
        _values[16] = this.listValue;
        _values[17] = this.listVar;
        _values[18] = new Integer(this.maxlength);
        _values[19] = this.maxlength_set ? Boolean.TRUE : Boolean.FALSE;
        _values[20] = this.onchange;
        _values[21] = this.onclick;
        _values[22] = this.onclickeffect;
        _values[23] = this.ondblclick;
        _values[24] = this.ondblclickeffect;
        _values[25] = this.onfocus;
        _values[26] = this.onkeydown;
        _values[27] = this.onkeydowneffect;
        _values[28] = this.onkeypress;
        _values[29] = this.onkeypresseffect;
        _values[30] = this.onkeyup;
        _values[31] = this.onkeyupeffect;
        _values[32] = this.onmousedown;
        _values[33] = this.onmousedowneffect;
        _values[34] = this.onmousemove;
        _values[35] = this.onmousemoveeffect;
        _values[36] = this.onmouseout;
        _values[37] = this.onmouseouteffect;
        _values[38] = this.onmouseover;
        _values[39] = this.onmouseovereffect;
        _values[40] = this.onmouseup;
        _values[41] = this.onmouseupeffect;
        _values[42] = this.onselect;
        _values[43] = this.options;
        _values[44] = this.partialSubmit ? Boolean.TRUE : Boolean.FALSE;
        _values[45] = this.partialSubmit_set ? Boolean.TRUE : Boolean.FALSE;
        _values[46] = this.readonly ? Boolean.TRUE : Boolean.FALSE;
        _values[47] = this.readonly_set ? Boolean.TRUE : Boolean.FALSE;
        _values[48] = this.rendered ? Boolean.TRUE : Boolean.FALSE;
        _values[49] = this.rendered_set ? Boolean.TRUE : Boolean.FALSE;
        _values[50] = this.renderedOnUserRole;
        _values[51] = this.required ? Boolean.TRUE : Boolean.FALSE;
        _values[52] = this.required_set ? Boolean.TRUE : Boolean.FALSE;
        _values[53] = this.requiredMessage;
        _values[54] = new Integer(this.rows);
        _values[55] = this.rows_set ? Boolean.TRUE : Boolean.FALSE;
        _values[56] = new Integer(this.size);
        _values[57] = this.size_set ? Boolean.TRUE : Boolean.FALSE;
        _values[58] = this.style;
        _values[59] = this.styleClass;
        _values[60] = this.tabindex;
        _values[61] = saveAttachedState(_context, textChangeListener);
        _values[62] = this.title;
        _values[63] = saveAttachedState(_context, validator);
        _values[64] = this.value;
        _values[65] = saveAttachedState(_context, valueChangeListener);
        _values[66] = this.visible ? Boolean.TRUE : Boolean.FALSE;
        _values[67] = this.visible_set ? Boolean.TRUE : Boolean.FALSE;
        _values[68] = this.width;
        return _values;
    }
