...
abstract class HtmlSelectManyMenuBase extends javax.faces.component.html.HtmlSelectManyMenu {

    /**
     * <p>Construct a new <code>HtmlSelectManyMenuBase</code>.</p>
     */
    public HtmlSelectManyMenuBase() {
        super();
        setRendererType("com.icesoft.faces.Menu");
    }
 ...
 *         use -1.</p>
    ...
    /**
 * <p>When this attribute is set to 'true', partial submit (if enabled) will occur only when blurring the field. Otherwise, it will occur whenever a different value is selected in the menu (either with the mouse or the keyboard). Default value is false.</p>
     */
