...
abstract class HtmlInputTextareaBase extends javax.faces.component.html.HtmlInputTextarea {

    /**
     * <p>Construct a new <code>HtmlInputTextareaBase</code>.</p>
     */
    public HtmlInputTextareaBase() {
        super();
        setRendererType("com.icesoft.faces.Textarea");
    }
 ...
 * <p>Passed through to root element.</p>
    ...
    // cols
    private int cols = Integer.MIN_VALUE;
    private boolean cols_set = false;
 ...
 * 		component.</p>
    ...
    /**
 * <p>The maximum number of characters that may be entered in this field.<br/>
 ...
 *         may appear briefly, before the ending of the text is truncated.</p>
     */
 ...
 * 	 	if enabled and <b>iceInpTxtArea-dis</b> if disabled.</p>
     */
 ...
 * 		set to display:none</p>
    ...
    public void restoreState(FacesContext _context,Object _state) {
        ...
        this.cols = ((Integer) _values[3]).intValue();
        this.cols_set = ((Boolean) _values[4]).booleanValue();
        ...
        this.effect = (com.icesoft.faces.context.effects.Effect) _values[9];
        ...
        this.maxlength = ((Integer) _values[15]).intValue();
        this.maxlength_set = ((Boolean) _values[16]).booleanValue();
        this.onchange = (String) _values[17];
        this.onclick = (String) _values[18];
        this.onclickeffect = (com.icesoft.faces.context.effects.Effect) _values[19];
        this.ondblclick = (String) _values[20];
        this.ondblclickeffect = (com.icesoft.faces.context.effects.Effect) _values[21];
        this.onfocus = (String) _values[22];
        this.onkeydown = (String) _values[23];
        this.onkeydowneffect = (com.icesoft.faces.context.effects.Effect) _values[24];
        this.onkeypress = (String) _values[25];
        this.onkeypresseffect = (com.icesoft.faces.context.effects.Effect) _values[26];
        this.onkeyup = (String) _values[27];
        this.onkeyupeffect = (com.icesoft.faces.context.effects.Effect) _values[28];
        this.onmousedown = (String) _values[29];
        this.onmousedowneffect = (com.icesoft.faces.context.effects.Effect) _values[30];
        this.onmousemove = (String) _values[31];
        this.onmousemoveeffect = (com.icesoft.faces.context.effects.Effect) _values[32];
        this.onmouseout = (String) _values[33];
        this.onmouseouteffect = (com.icesoft.faces.context.effects.Effect) _values[34];
        this.onmouseover = (String) _values[35];
        this.onmouseovereffect = (com.icesoft.faces.context.effects.Effect) _values[36];
        this.onmouseup = (String) _values[37];
        this.onmouseupeffect = (com.icesoft.faces.context.effects.Effect) _values[38];
        this.onselect = (String) _values[39];
        ...
        this.rows = ((Integer) _values[50]).intValue();
        this.rows_set = ((Boolean) _values[51]).booleanValue();
        this.style = (String) _values[52];
        this.styleClass = (String) _values[53];
        this.tabindex = (String) _values[54];
        this.title = (String) _values[55];
        this.validator = (javax.faces.el.MethodBinding) restoreAttachedState(_context, _values[56]);
        this.value = (Object) _values[57];
        this.valueChangeListener = (javax.faces.el.MethodBinding) restoreAttachedState(_context, _values[58]);
        this.visible = ((Boolean) _values[59]).booleanValue();
        this.visible_set = ((Boolean) _values[60]).booleanValue();
    }
    ...
    public Object saveState(FacesContext _context) {
        Object _values[] = new Object[61];
        _values[0] = super.saveState(_context);
        _values[1] = this.accesskey;
        _values[2] = this.autocomplete;
        _values[3] = new Integer(this.cols);
        _values[4] = this.cols_set ? Boolean.TRUE : Boolean.FALSE;
        ...
        _values[15] = new Integer(this.maxlength);
        _values[16] = this.maxlength_set ? Boolean.TRUE : Boolean.FALSE;
        _values[17] = this.onchange;
        _values[18] = this.onclick;
        _values[19] = this.onclickeffect;
        _values[20] = this.ondblclick;
        _values[21] = this.ondblclickeffect;
        _values[22] = this.onfocus;
        _values[23] = this.onkeydown;
        _values[24] = this.onkeydowneffect;
        _values[25] = this.onkeypress;
        _values[26] = this.onkeypresseffect;
        _values[27] = this.onkeyup;
        _values[28] = this.onkeyupeffect;
        _values[29] = this.onmousedown;
        _values[30] = this.onmousedowneffect;
        _values[31] = this.onmousemove;
        _values[32] = this.onmousemoveeffect;
        _values[33] = this.onmouseout;
        _values[34] = this.onmouseouteffect;
        _values[35] = this.onmouseover;
        _values[36] = this.onmouseovereffect;
        _values[37] = this.onmouseup;
        _values[38] = this.onmouseupeffect;
        _values[39] = this.onselect;
        ...
        _values[50] = new Integer(this.rows);
        _values[51] = this.rows_set ? Boolean.TRUE : Boolean.FALSE;
        _values[52] = this.style;
        _values[53] = this.styleClass;
        _values[54] = this.tabindex;
        _values[55] = this.title;
        _values[56] = saveAttachedState(_context, validator);
        _values[57] = this.value;
        _values[58] = saveAttachedState(_context, valueChangeListener);
        _values[59] = this.visible ? Boolean.TRUE : Boolean.FALSE;
        _values[60] = this.visible_set ? Boolean.TRUE : Boolean.FALSE;
        return _values;
    }
