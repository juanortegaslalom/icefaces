...
abstract class HtmlInputSecretBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("com.icesoft.faces.component.ext.Bundle-JSF", Locale.getDefault(), HtmlInputSecretBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>HtmlInputSecretBeanInfoBase</code>.</p>
     */
    public HtmlInputSecretBeanInfoBase() {

        beanClass = HtmlInputSecret.class;
        iconFileName_C16 = "HtmlInputSecret_C16";
        iconFileName_C32 = "HtmlInputSecret_C32";
        iconFileName_M16 = "HtmlInputSecret_M16";
        iconFileName_M32 = "HtmlInputSecret_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"inputSecret");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_action.setDisplayName(resources.getString("HtmlInputSecret_action_DisplayName"));
            prop_action.setShortDescription(resources.getString("HtmlInputSecret_action_Description"));
            ...
            prop_actionListener.setDisplayName(resources.getString("HtmlInputSecret_actionListener_DisplayName"));
            prop_actionListener.setShortDescription(resources.getString("HtmlInputSecret_actionListener_Description"));
            ...
            prop_autocomplete.setDisplayName(resources.getString("HtmlInputSecret_autocomplete_DisplayName"));
            prop_autocomplete.setShortDescription(resources.getString("HtmlInputSecret_autocomplete_Description"));
            ...
            prop_converter.setDisplayName(resources.getString("HtmlInputSecret_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("HtmlInputSecret_converter_Description"));
            ...
            prop_effect.setDisplayName(resources.getString("HtmlInputSecret_effect_DisplayName"));
            prop_effect.setShortDescription(resources.getString("HtmlInputSecret_effect_Description"));
            ...
            prop_enabledOnUserRole.setDisplayName(resources.getString("HtmlInputSecret_enabledOnUserRole_DisplayName"));
            prop_enabledOnUserRole.setShortDescription(resources.getString("HtmlInputSecret_enabledOnUserRole_Description"));
            ...
            prop_id.setDisplayName(resources.getString("HtmlInputSecret_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("HtmlInputSecret_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("HtmlInputSecret_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("HtmlInputSecret_immediate_Description"));
            ...
            prop_onchange.setDisplayName(resources.getString("HtmlInputSecret_onchange_DisplayName"));
            prop_onchange.setShortDescription(resources.getString("HtmlInputSecret_onchange_Description"));
            ...
            prop_onclick.setDisplayName(resources.getString("HtmlInputSecret_onclick_DisplayName"));
            prop_onclick.setShortDescription(resources.getString("HtmlInputSecret_onclick_Description"));
            ...
            prop_onclickeffect.setDisplayName(resources.getString("HtmlInputSecret_onclickeffect_DisplayName"));
            prop_onclickeffect.setShortDescription(resources.getString("HtmlInputSecret_onclickeffect_Description"));
            ...
            prop_ondblclick.setDisplayName(resources.getString("HtmlInputSecret_ondblclick_DisplayName"));
            prop_ondblclick.setShortDescription(resources.getString("HtmlInputSecret_ondblclick_Description"));
            ...
            prop_ondblclickeffect.setDisplayName(resources.getString("HtmlInputSecret_ondblclickeffect_DisplayName"));
            prop_ondblclickeffect.setShortDescription(resources.getString("HtmlInputSecret_ondblclickeffect_Description"));
            ...
            prop_onfocus.setDisplayName(resources.getString("HtmlInputSecret_onfocus_DisplayName"));
            prop_onfocus.setShortDescription(resources.getString("HtmlInputSecret_onfocus_Description"));
            ...
            prop_onkeydown.setDisplayName(resources.getString("HtmlInputSecret_onkeydown_DisplayName"));
            prop_onkeydown.setShortDescription(resources.getString("HtmlInputSecret_onkeydown_Description"));
            ...
            prop_onkeydowneffect.setDisplayName(resources.getString("HtmlInputSecret_onkeydowneffect_DisplayName"));
            prop_onkeydowneffect.setShortDescription(resources.getString("HtmlInputSecret_onkeydowneffect_Description"));
            ...
            prop_onkeypress.setDisplayName(resources.getString("HtmlInputSecret_onkeypress_DisplayName"));
            prop_onkeypress.setShortDescription(resources.getString("HtmlInputSecret_onkeypress_Description"));
            ...
            prop_onkeypresseffect.setDisplayName(resources.getString("HtmlInputSecret_onkeypresseffect_DisplayName"));
            prop_onkeypresseffect.setShortDescription(resources.getString("HtmlInputSecret_onkeypresseffect_Description"));
            ...
            prop_onkeyup.setDisplayName(resources.getString("HtmlInputSecret_onkeyup_DisplayName"));
            prop_onkeyup.setShortDescription(resources.getString("HtmlInputSecret_onkeyup_Description"));
            ...
            prop_onkeyupeffect.setDisplayName(resources.getString("HtmlInputSecret_onkeyupeffect_DisplayName"));
            prop_onkeyupeffect.setShortDescription(resources.getString("HtmlInputSecret_onkeyupeffect_Description"));
            ...
            prop_onmousedown.setDisplayName(resources.getString("HtmlInputSecret_onmousedown_DisplayName"));
            prop_onmousedown.setShortDescription(resources.getString("HtmlInputSecret_onmousedown_Description"));
            ...
            prop_onmousedowneffect.setDisplayName(resources.getString("HtmlInputSecret_onmousedowneffect_DisplayName"));
            prop_onmousedowneffect.setShortDescription(resources.getString("HtmlInputSecret_onmousedowneffect_Description"));
            ...
            prop_onmousemove.setDisplayName(resources.getString("HtmlInputSecret_onmousemove_DisplayName"));
            prop_onmousemove.setShortDescription(resources.getString("HtmlInputSecret_onmousemove_Description"));
            ...
            prop_onmousemoveeffect.setDisplayName(resources.getString("HtmlInputSecret_onmousemoveeffect_DisplayName"));
            prop_onmousemoveeffect.setShortDescription(resources.getString("HtmlInputSecret_onmousemoveeffect_Description"));
            ...
            prop_onmouseout.setDisplayName(resources.getString("HtmlInputSecret_onmouseout_DisplayName"));
            prop_onmouseout.setShortDescription(resources.getString("HtmlInputSecret_onmouseout_Description"));
            ...
            prop_onmouseouteffect.setDisplayName(resources.getString("HtmlInputSecret_onmouseouteffect_DisplayName"));
            prop_onmouseouteffect.setShortDescription(resources.getString("HtmlInputSecret_onmouseouteffect_Description"));
            ...
            prop_onmouseover.setDisplayName(resources.getString("HtmlInputSecret_onmouseover_DisplayName"));
            prop_onmouseover.setShortDescription(resources.getString("HtmlInputSecret_onmouseover_Description"));
            ...
            prop_onmouseovereffect.setDisplayName(resources.getString("HtmlInputSecret_onmouseovereffect_DisplayName"));
            prop_onmouseovereffect.setShortDescription(resources.getString("HtmlInputSecret_onmouseovereffect_Description"));
            ...
            prop_onmouseup.setDisplayName(resources.getString("HtmlInputSecret_onmouseup_DisplayName"));
            prop_onmouseup.setShortDescription(resources.getString("HtmlInputSecret_onmouseup_Description"));
            ...
            prop_onmouseupeffect.setDisplayName(resources.getString("HtmlInputSecret_onmouseupeffect_DisplayName"));
            prop_onmouseupeffect.setShortDescription(resources.getString("HtmlInputSecret_onmouseupeffect_Description"));
            ...
            prop_onselect.setDisplayName(resources.getString("HtmlInputSecret_onselect_DisplayName"));
            prop_onselect.setShortDescription(resources.getString("HtmlInputSecret_onselect_Description"));
            ...
            prop_partialSubmit.setDisplayName(resources.getString("HtmlInputSecret_partialSubmit_DisplayName"));
            prop_partialSubmit.setShortDescription(resources.getString("HtmlInputSecret_partialSubmit_Description"));
            ...
            PropertyDescriptor prop_redisplay = new PropertyDescriptor("redisplay",beanClass,"isRedisplay","setRedisplay");
            ...
            attrib = new AttributeDescriptor("redisplay",false,"false",true);
            prop_redisplay.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_redisplay.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.ICE_COMPONENT);

            PropertyDescriptor prop_rendered = new PropertyDescriptor("rendered",beanClass,"isRendered","setRendered");
            prop_rendered.setDisplayName(resources.getString("HtmlInputSecret_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("HtmlInputSecret_rendered_Description"));
            ...
            prop_renderedOnUserRole.setDisplayName(resources.getString("HtmlInputSecret_renderedOnUserRole_DisplayName"));
            prop_renderedOnUserRole.setShortDescription(resources.getString("HtmlInputSecret_renderedOnUserRole_Description"));
            ...
            prop_required.setDisplayName(resources.getString("HtmlInputSecret_required_DisplayName"));
            prop_required.setShortDescription(resources.getString("HtmlInputSecret_required_Description"));
            ...
            prop_requiredMessage.setDisplayName(resources.getString("HtmlInputSecret_requiredMessage_DisplayName"));
            prop_requiredMessage.setShortDescription(resources.getString("HtmlInputSecret_requiredMessage_Description"));
            ...
            prop_style.setDisplayName(resources.getString("HtmlInputSecret_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("HtmlInputSecret_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("HtmlInputSecret_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("HtmlInputSecret_styleClass_Description"));
            ...
            prop_validator.setDisplayName(resources.getString("HtmlInputSecret_validator_DisplayName"));
            prop_validator.setShortDescription(resources.getString("HtmlInputSecret_validator_Description"));
            ...
            prop_value.setDisplayName(resources.getString("HtmlInputSecret_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("HtmlInputSecret_value_Description"));
            ...
            prop_valueChangeListener.setDisplayName(resources.getString("HtmlInputSecret_valueChangeListener_DisplayName"));
            prop_valueChangeListener.setShortDescription(resources.getString("HtmlInputSecret_valueChangeListener_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("HtmlInputSecret_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("HtmlInputSecret_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("HtmlInputSecret_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("HtmlInputSecret_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("HtmlInputSecret_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("HtmlInputSecret_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("HtmlInputSecret_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("HtmlInputSecret_children_Description"));
            ...
            prop_converterMessage.setDisplayName(resources.getString("HtmlInputSecret_converterMessage_DisplayName"));
            prop_converterMessage.setShortDescription(resources.getString("HtmlInputSecret_converterMessage_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("HtmlInputSecret_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("HtmlInputSecret_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("HtmlInputSecret_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("HtmlInputSecret_family_Description"));
            ...
            prop_label.setDisplayName(resources.getString("HtmlInputSecret_label_DisplayName"));
            prop_label.setShortDescription(resources.getString("HtmlInputSecret_label_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("HtmlInputSecret_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("HtmlInputSecret_localValue_Description"));
            ...
            prop_localValueSet.setDisplayName(resources.getString("HtmlInputSecret_localValueSet_DisplayName"));
            prop_localValueSet.setShortDescription(resources.getString("HtmlInputSecret_localValueSet_Description"));
            ...
            prop_onblur.setDisplayName(resources.getString("HtmlInputSecret_onblur_DisplayName"));
            prop_onblur.setShortDescription(resources.getString("HtmlInputSecret_onblur_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("HtmlInputSecret_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("HtmlInputSecret_parent_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("HtmlInputSecret_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("HtmlInputSecret_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("HtmlInputSecret_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("HtmlInputSecret_rendersChildren_Description"));
            ...
            prop_submittedValue.setDisplayName(resources.getString("HtmlInputSecret_submittedValue_DisplayName"));
            prop_submittedValue.setShortDescription(resources.getString("HtmlInputSecret_submittedValue_Description"));
            ...
            prop_validatorMessage.setDisplayName(resources.getString("HtmlInputSecret_validatorMessage_DisplayName"));
            prop_validatorMessage.setShortDescription(resources.getString("HtmlInputSecret_validatorMessage_Description"));
