...
abstract class PanelTabSetBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("com.icesoft.faces.component.paneltabset.Bundle-JSF", Locale.getDefault(), PanelTabSetBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>PanelTabSetBeanInfoBase</code>.</p>
     */
    public PanelTabSetBeanInfoBase() {

        beanClass = PanelTabSet.class;
        iconFileName_C16 = "PanelTabSet_C16";
        iconFileName_C32 = "PanelTabSet_C32";
        iconFileName_M16 = "PanelTabSet_M16";
        iconFileName_M32 = "PanelTabSet_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("PanelTabSet_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("PanelTabSet_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"panelTabSet");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.MARKUP_SECTION,"form");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"panelTabSet");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_align.setDisplayName(resources.getString("PanelTabSet_align_DisplayName"));
            prop_align.setShortDescription(resources.getString("PanelTabSet_align_Description"));
            ...
            prop_align.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.ICE_COMPONENT);

            PropertyDescriptor prop_bgcolor = new PropertyDescriptor("bgcolor",beanClass,"getBgcolor","setBgcolor");
            prop_bgcolor.setDisplayName(resources.getString("PanelTabSet_bgcolor_DisplayName"));
            prop_bgcolor.setShortDescription(resources.getString("PanelTabSet_bgcolor_Description"));
            ...
            prop_border.setDisplayName(resources.getString("PanelTabSet_border_DisplayName"));
            prop_border.setShortDescription(resources.getString("PanelTabSet_border_Description"));
            ...
            prop_cellpadding.setDisplayName(resources.getString("PanelTabSet_cellpadding_DisplayName"));
            prop_cellpadding.setShortDescription(resources.getString("PanelTabSet_cellpadding_Description"));
            ...
            prop_cellspacing.setDisplayName(resources.getString("PanelTabSet_cellspacing_DisplayName"));
            prop_cellspacing.setShortDescription(resources.getString("PanelTabSet_cellspacing_Description"));
            ...
            prop_dir.setDisplayName(resources.getString("PanelTabSet_dir_DisplayName"));
            prop_dir.setShortDescription(resources.getString("PanelTabSet_dir_Description"));
            ...
            prop_first.setDisplayName(resources.getString("PanelTabSet_first_DisplayName"));
            prop_first.setShortDescription(resources.getString("PanelTabSet_first_Description"));
            prop_first.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.faces.dt.std.ValueBindingPropertyEditor"));
            ...
            prop_first.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.ICE_LAYOUT);

            PropertyDescriptor prop_frame = new PropertyDescriptor("frame",beanClass,"getFrame","setFrame");
            prop_frame.setDisplayName(resources.getString("PanelTabSet_frame_DisplayName"));
            prop_frame.setShortDescription(resources.getString("PanelTabSet_frame_Description"));
            ...
            prop_height.setDisplayName(resources.getString("PanelTabSet_height_DisplayName"));
            prop_height.setShortDescription(resources.getString("PanelTabSet_height_Description"));
            ...
            prop_id.setDisplayName(resources.getString("PanelTabSet_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("PanelTabSet_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("PanelTabSet_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("PanelTabSet_immediate_Description"));
            ...
            prop_keyboardNavigationEnabled.setDisplayName(resources.getString("PanelTabSet_keyboardNavigationEnabled_DisplayName"));
            prop_keyboardNavigationEnabled.setShortDescription(resources.getString("PanelTabSet_keyboardNavigationEnabled_Description"));
            ...
            prop_lang.setDisplayName(resources.getString("PanelTabSet_lang_DisplayName"));
            prop_lang.setShortDescription(resources.getString("PanelTabSet_lang_Description"));
            ...
            prop_onclick.setDisplayName(resources.getString("PanelTabSet_onclick_DisplayName"));
            prop_onclick.setShortDescription(resources.getString("PanelTabSet_onclick_Description"));
            ...
            prop_ondblclick.setDisplayName(resources.getString("PanelTabSet_ondblclick_DisplayName"));
            prop_ondblclick.setShortDescription(resources.getString("PanelTabSet_ondblclick_Description"));
            ...
            prop_onkeydown.setDisplayName(resources.getString("PanelTabSet_onkeydown_DisplayName"));
            prop_onkeydown.setShortDescription(resources.getString("PanelTabSet_onkeydown_Description"));
            ...
            prop_onkeypress.setDisplayName(resources.getString("PanelTabSet_onkeypress_DisplayName"));
            prop_onkeypress.setShortDescription(resources.getString("PanelTabSet_onkeypress_Description"));
            ...
            prop_onkeyup.setDisplayName(resources.getString("PanelTabSet_onkeyup_DisplayName"));
            prop_onkeyup.setShortDescription(resources.getString("PanelTabSet_onkeyup_Description"));
            ...
            prop_onmousedown.setDisplayName(resources.getString("PanelTabSet_onmousedown_DisplayName"));
            prop_onmousedown.setShortDescription(resources.getString("PanelTabSet_onmousedown_Description"));
            ...
            prop_onmousemove.setDisplayName(resources.getString("PanelTabSet_onmousemove_DisplayName"));
            prop_onmousemove.setShortDescription(resources.getString("PanelTabSet_onmousemove_Description"));
            ...
            prop_onmouseout.setDisplayName(resources.getString("PanelTabSet_onmouseout_DisplayName"));
            prop_onmouseout.setShortDescription(resources.getString("PanelTabSet_onmouseout_Description"));
            ...
            prop_onmouseover.setDisplayName(resources.getString("PanelTabSet_onmouseover_DisplayName"));
            prop_onmouseover.setShortDescription(resources.getString("PanelTabSet_onmouseover_Description"));
            ...
            prop_onmouseup.setDisplayName(resources.getString("PanelTabSet_onmouseup_DisplayName"));
            prop_onmouseup.setShortDescription(resources.getString("PanelTabSet_onmouseup_Description"));
            ...
            prop_partialSubmit.setDisplayName(resources.getString("PanelTabSet_partialSubmit_DisplayName"));
            prop_partialSubmit.setShortDescription(resources.getString("PanelTabSet_partialSubmit_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("PanelTabSet_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("PanelTabSet_rendered_Description"));
            ...
            prop_renderedOnUserRole.setDisplayName(resources.getString("PanelTabSet_renderedOnUserRole_DisplayName"));
            prop_renderedOnUserRole.setShortDescription(resources.getString("PanelTabSet_renderedOnUserRole_Description"));
            ...
            prop_rows.setDisplayName(resources.getString("PanelTabSet_rows_DisplayName"));
            prop_rows.setShortDescription(resources.getString("PanelTabSet_rows_Description"));
            ...
            prop_rules.setDisplayName(resources.getString("PanelTabSet_rules_DisplayName"));
            prop_rules.setShortDescription(resources.getString("PanelTabSet_rules_Description"));
            ...
            PropertyDescriptor prop_selectedIndex = new PropertyDescriptor("selectedIndex",beanClass,"getSelectedIndex","setSelectedIndex");
            prop_selectedIndex.setDisplayName(resources.getString("PanelTabSet_selectedIndex_DisplayName"));
            prop_selectedIndex.setShortDescription(resources.getString("PanelTabSet_selectedIndex_Description"));
            prop_selectedIndex.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.propertyeditors.IntegerPropertyEditor"));
            prop_selectedIndex.setExpert(false);
            prop_selectedIndex.setHidden(false);
            prop_selectedIndex.setPreferred(false);
            attrib = new AttributeDescriptor("selectedIndex",false,"0",true);
            prop_selectedIndex.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_selectedIndex.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.ICE_LAYOUT);
            prop_selectedIndex.setValue("minValue", new Integer(0));

            PropertyDescriptor prop_style = new PropertyDescriptor("style",beanClass,"getStyle","setStyle");
            prop_style.setDisplayName(resources.getString("PanelTabSet_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("PanelTabSet_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("PanelTabSet_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("PanelTabSet_styleClass_Description"));
            ...
            prop_summary.setDisplayName(resources.getString("PanelTabSet_summary_DisplayName"));
            prop_summary.setShortDescription(resources.getString("PanelTabSet_summary_Description"));
            ...
            PropertyDescriptor prop_tabChangeListener = new PropertyDescriptor("tabChangeListener",beanClass,"getTabChangeListener","setTabChangeListener");
            prop_tabChangeListener.setDisplayName(resources.getString("PanelTabSet_tabChangeListener_DisplayName"));
            prop_tabChangeListener.setShortDescription(resources.getString("PanelTabSet_tabChangeListener_Description"));
            prop_tabChangeListener.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.propertyeditors.MethodBindingPropertyEditor"));
            prop_tabChangeListener.setExpert(false);
            prop_tabChangeListener.setHidden(false);
            prop_tabChangeListener.setPreferred(false);
            attrib = new AttributeDescriptor("tabChangeListener",false,null,true);
            prop_tabChangeListener.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_tabChangeListener.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.ICE_LAYOUT);

            PropertyDescriptor prop_tabPlacement = new PropertyDescriptor("tabPlacement",beanClass,"getTabPlacement","setTabPlacement");
            prop_tabPlacement.setDisplayName(resources.getString("PanelTabSet_tabPlacement_DisplayName"));
            prop_tabPlacement.setShortDescription(resources.getString("PanelTabSet_tabPlacement_Description"));
            prop_tabPlacement.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.propertyeditors.StringPropertyEditor"));
            prop_tabPlacement.setExpert(false);
            prop_tabPlacement.setHidden(false);
            prop_tabPlacement.setPreferred(false);
            attrib = new AttributeDescriptor("tabPlacement",false,"Top",true);
            prop_tabPlacement.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_tabPlacement.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.ICE_LAYOUT);

            PropertyDescriptor prop_tabindex = new PropertyDescriptor("tabindex",beanClass,"getTabindex","setTabindex");
            prop_tabindex.setDisplayName(resources.getString("PanelTabSet_tabindex_DisplayName"));
            prop_tabindex.setShortDescription(resources.getString("PanelTabSet_tabindex_Description"));
            ...
            prop_title.setDisplayName(resources.getString("PanelTabSet_title_DisplayName"));
            prop_title.setShortDescription(resources.getString("PanelTabSet_title_Description"));
            ...
            prop_value.setDisplayName(resources.getString("PanelTabSet_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("PanelTabSet_value_Description"));
            ...
            prop_var.setDisplayName(resources.getString("PanelTabSet_var_DisplayName"));
            prop_var.setShortDescription(resources.getString("PanelTabSet_var_Description"));
            ...
            prop_varStatus.setDisplayName(resources.getString("PanelTabSet_varStatus_DisplayName"));
            prop_varStatus.setShortDescription(resources.getString("PanelTabSet_varStatus_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("PanelTabSet_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("PanelTabSet_visible_Description"));
            ...
            prop_width.setDisplayName(resources.getString("PanelTabSet_width_DisplayName"));
            prop_width.setShortDescription(resources.getString("PanelTabSet_width_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("PanelTabSet_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("PanelTabSet_attributes_Description"));
            ...
            prop_bodyrows.setDisplayName(resources.getString("PanelTabSet_bodyrows_DisplayName"));
            prop_bodyrows.setShortDescription(resources.getString("PanelTabSet_bodyrows_Description"));
            ...
            prop_captionClass.setDisplayName(resources.getString("PanelTabSet_captionClass_DisplayName"));
            prop_captionClass.setShortDescription(resources.getString("PanelTabSet_captionClass_Description"));
            ...
            prop_captionStyle.setDisplayName(resources.getString("PanelTabSet_captionStyle_DisplayName"));
            prop_captionStyle.setShortDescription(resources.getString("PanelTabSet_captionStyle_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("PanelTabSet_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("PanelTabSet_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("PanelTabSet_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("PanelTabSet_children_Description"));
            ...
            prop_columnClasses.setDisplayName(resources.getString("PanelTabSet_columnClasses_DisplayName"));
            prop_columnClasses.setShortDescription(resources.getString("PanelTabSet_columnClasses_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("PanelTabSet_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("PanelTabSet_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("PanelTabSet_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("PanelTabSet_family_Description"));
            ...
            prop_footerClass.setDisplayName(resources.getString("PanelTabSet_footerClass_DisplayName"));
            prop_footerClass.setShortDescription(resources.getString("PanelTabSet_footerClass_Description"));
            ...
            prop_headerClass.setDisplayName(resources.getString("PanelTabSet_headerClass_DisplayName"));
            prop_headerClass.setShortDescription(resources.getString("PanelTabSet_headerClass_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("PanelTabSet_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("PanelTabSet_parent_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("PanelTabSet_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("PanelTabSet_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("PanelTabSet_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("PanelTabSet_rendersChildren_Description"));
            ...
            prop_rowAvailable.setDisplayName(resources.getString("PanelTabSet_rowAvailable_DisplayName"));
            prop_rowAvailable.setShortDescription(resources.getString("PanelTabSet_rowAvailable_Description"));
            ...
            prop_rowClasses.setDisplayName(resources.getString("PanelTabSet_rowClasses_DisplayName"));
            prop_rowClasses.setShortDescription(resources.getString("PanelTabSet_rowClasses_Description"));
            ...
            prop_rowCount.setDisplayName(resources.getString("PanelTabSet_rowCount_DisplayName"));
            prop_rowCount.setShortDescription(resources.getString("PanelTabSet_rowCount_Description"));
            ...
            prop_rowData.setDisplayName(resources.getString("PanelTabSet_rowData_DisplayName"));
            prop_rowData.setShortDescription(resources.getString("PanelTabSet_rowData_Description"));
            ...
            prop_rowIndex.setDisplayName(resources.getString("PanelTabSet_rowIndex_DisplayName"));
            prop_rowIndex.setShortDescription(resources.getString("PanelTabSet_rowIndex_Description"));
            ...
            prop_rowStatePreserved.setDisplayName(resources.getString("PanelTabSet_rowStatePreserved_DisplayName"));
            prop_rowStatePreserved.setShortDescription(resources.getString("PanelTabSet_rowStatePreserved_Description"));
