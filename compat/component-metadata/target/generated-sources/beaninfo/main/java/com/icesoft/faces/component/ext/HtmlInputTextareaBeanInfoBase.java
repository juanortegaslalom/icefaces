...
abstract class HtmlInputTextareaBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("com.icesoft.faces.component.ext.Bundle-JSF", Locale.getDefault(), HtmlInputTextareaBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>HtmlInputTextareaBeanInfoBase</code>.</p>
     */
    public HtmlInputTextareaBeanInfoBase() {

        beanClass = HtmlInputTextarea.class;
        iconFileName_C16 = "HtmlInputTextarea_C16";
        iconFileName_C32 = "HtmlInputTextarea_C32";
        iconFileName_M16 = "HtmlInputTextarea_M16";
        iconFileName_M32 = "HtmlInputTextarea_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"inputTextarea");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_autocomplete.setDisplayName(resources.getString("HtmlInputTextarea_autocomplete_DisplayName"));
            prop_autocomplete.setShortDescription(resources.getString("HtmlInputTextarea_autocomplete_Description"));
            ...
            prop_cols.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.propertyeditors.IntegerPropertyEditor"));
            ...
            prop_cols.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.APPEARANCE);
            ...
            prop_converter.setDisplayName(resources.getString("HtmlInputTextarea_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("HtmlInputTextarea_converter_Description"));
            ...
            prop_effect.setDisplayName(resources.getString("HtmlInputTextarea_effect_DisplayName"));
            prop_effect.setShortDescription(resources.getString("HtmlInputTextarea_effect_Description"));
            ...
            prop_enabledOnUserRole.setDisplayName(resources.getString("HtmlInputTextarea_enabledOnUserRole_DisplayName"));
            prop_enabledOnUserRole.setShortDescription(resources.getString("HtmlInputTextarea_enabledOnUserRole_Description"));
            ...
            prop_id.setDisplayName(resources.getString("HtmlInputTextarea_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("HtmlInputTextarea_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("HtmlInputTextarea_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("HtmlInputTextarea_immediate_Description"));
            ...
            prop_maxlength.setDisplayName(resources.getString("HtmlInputTextarea_maxlength_DisplayName"));
            prop_maxlength.setShortDescription(resources.getString("HtmlInputTextarea_maxlength_Description"));
            prop_maxlength.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.propertyeditors.IntegerPropertyEditor"));
            ...
            prop_onchange.setDisplayName(resources.getString("HtmlInputTextarea_onchange_DisplayName"));
            prop_onchange.setShortDescription(resources.getString("HtmlInputTextarea_onchange_Description"));
            ...
            prop_onclick.setDisplayName(resources.getString("HtmlInputTextarea_onclick_DisplayName"));
            prop_onclick.setShortDescription(resources.getString("HtmlInputTextarea_onclick_Description"));
            ...
            prop_onclickeffect.setDisplayName(resources.getString("HtmlInputTextarea_onclickeffect_DisplayName"));
            prop_onclickeffect.setShortDescription(resources.getString("HtmlInputTextarea_onclickeffect_Description"));
            ...
            prop_ondblclick.setDisplayName(resources.getString("HtmlInputTextarea_ondblclick_DisplayName"));
            prop_ondblclick.setShortDescription(resources.getString("HtmlInputTextarea_ondblclick_Description"));
            ...
            prop_ondblclickeffect.setDisplayName(resources.getString("HtmlInputTextarea_ondblclickeffect_DisplayName"));
            prop_ondblclickeffect.setShortDescription(resources.getString("HtmlInputTextarea_ondblclickeffect_Description"));
            ...
            prop_onfocus.setDisplayName(resources.getString("HtmlInputTextarea_onfocus_DisplayName"));
            prop_onfocus.setShortDescription(resources.getString("HtmlInputTextarea_onfocus_Description"));
            ...
            prop_onkeydown.setDisplayName(resources.getString("HtmlInputTextarea_onkeydown_DisplayName"));
            prop_onkeydown.setShortDescription(resources.getString("HtmlInputTextarea_onkeydown_Description"));
            ...
            prop_onkeydowneffect.setDisplayName(resources.getString("HtmlInputTextarea_onkeydowneffect_DisplayName"));
            prop_onkeydowneffect.setShortDescription(resources.getString("HtmlInputTextarea_onkeydowneffect_Description"));
            ...
            prop_onkeypress.setDisplayName(resources.getString("HtmlInputTextarea_onkeypress_DisplayName"));
            prop_onkeypress.setShortDescription(resources.getString("HtmlInputTextarea_onkeypress_Description"));
            ...
            prop_onkeypresseffect.setDisplayName(resources.getString("HtmlInputTextarea_onkeypresseffect_DisplayName"));
            prop_onkeypresseffect.setShortDescription(resources.getString("HtmlInputTextarea_onkeypresseffect_Description"));
            ...
            prop_onkeyup.setDisplayName(resources.getString("HtmlInputTextarea_onkeyup_DisplayName"));
            prop_onkeyup.setShortDescription(resources.getString("HtmlInputTextarea_onkeyup_Description"));
            ...
            prop_onkeyupeffect.setDisplayName(resources.getString("HtmlInputTextarea_onkeyupeffect_DisplayName"));
            prop_onkeyupeffect.setShortDescription(resources.getString("HtmlInputTextarea_onkeyupeffect_Description"));
            ...
            prop_onmousedown.setDisplayName(resources.getString("HtmlInputTextarea_onmousedown_DisplayName"));
            prop_onmousedown.setShortDescription(resources.getString("HtmlInputTextarea_onmousedown_Description"));
            ...
            prop_onmousedowneffect.setDisplayName(resources.getString("HtmlInputTextarea_onmousedowneffect_DisplayName"));
            prop_onmousedowneffect.setShortDescription(resources.getString("HtmlInputTextarea_onmousedowneffect_Description"));
            ...
            prop_onmousemove.setDisplayName(resources.getString("HtmlInputTextarea_onmousemove_DisplayName"));
            prop_onmousemove.setShortDescription(resources.getString("HtmlInputTextarea_onmousemove_Description"));
            ...
            prop_onmousemoveeffect.setDisplayName(resources.getString("HtmlInputTextarea_onmousemoveeffect_DisplayName"));
            prop_onmousemoveeffect.setShortDescription(resources.getString("HtmlInputTextarea_onmousemoveeffect_Description"));
            ...
            prop_onmouseout.setDisplayName(resources.getString("HtmlInputTextarea_onmouseout_DisplayName"));
            prop_onmouseout.setShortDescription(resources.getString("HtmlInputTextarea_onmouseout_Description"));
            ...
            prop_onmouseouteffect.setDisplayName(resources.getString("HtmlInputTextarea_onmouseouteffect_DisplayName"));
            prop_onmouseouteffect.setShortDescription(resources.getString("HtmlInputTextarea_onmouseouteffect_Description"));
            ...
            prop_onmouseover.setDisplayName(resources.getString("HtmlInputTextarea_onmouseover_DisplayName"));
            prop_onmouseover.setShortDescription(resources.getString("HtmlInputTextarea_onmouseover_Description"));
            ...
            prop_onmouseovereffect.setDisplayName(resources.getString("HtmlInputTextarea_onmouseovereffect_DisplayName"));
            prop_onmouseovereffect.setShortDescription(resources.getString("HtmlInputTextarea_onmouseovereffect_Description"));
            ...
            prop_onmouseup.setDisplayName(resources.getString("HtmlInputTextarea_onmouseup_DisplayName"));
            prop_onmouseup.setShortDescription(resources.getString("HtmlInputTextarea_onmouseup_Description"));
            ...
            prop_onmouseupeffect.setDisplayName(resources.getString("HtmlInputTextarea_onmouseupeffect_DisplayName"));
            prop_onmouseupeffect.setShortDescription(resources.getString("HtmlInputTextarea_onmouseupeffect_Description"));
            ...
            prop_onselect.setDisplayName(resources.getString("HtmlInputTextarea_onselect_DisplayName"));
            prop_onselect.setShortDescription(resources.getString("HtmlInputTextarea_onselect_Description"));
            ...
            prop_partialSubmit.setDisplayName(resources.getString("HtmlInputTextarea_partialSubmit_DisplayName"));
            prop_partialSubmit.setShortDescription(resources.getString("HtmlInputTextarea_partialSubmit_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("HtmlInputTextarea_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("HtmlInputTextarea_rendered_Description"));
            ...
            prop_renderedOnUserRole.setDisplayName(resources.getString("HtmlInputTextarea_renderedOnUserRole_DisplayName"));
            prop_renderedOnUserRole.setShortDescription(resources.getString("HtmlInputTextarea_renderedOnUserRole_Description"));
            ...
            prop_required.setDisplayName(resources.getString("HtmlInputTextarea_required_DisplayName"));
            prop_required.setShortDescription(resources.getString("HtmlInputTextarea_required_Description"));
            ...
            prop_requiredMessage.setDisplayName(resources.getString("HtmlInputTextarea_requiredMessage_DisplayName"));
            prop_requiredMessage.setShortDescription(resources.getString("HtmlInputTextarea_requiredMessage_Description"));
            ...
            prop_style.setDisplayName(resources.getString("HtmlInputTextarea_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("HtmlInputTextarea_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("HtmlInputTextarea_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("HtmlInputTextarea_styleClass_Description"));
            ...
            prop_styleClass.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.JAVASCRIPT);
            ...
            prop_validator.setDisplayName(resources.getString("HtmlInputTextarea_validator_DisplayName"));
            prop_validator.setShortDescription(resources.getString("HtmlInputTextarea_validator_Description"));
            ...
            prop_value.setDisplayName(resources.getString("HtmlInputTextarea_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("HtmlInputTextarea_value_Description"));
            ...
            prop_valueChangeListener.setDisplayName(resources.getString("HtmlInputTextarea_valueChangeListener_DisplayName"));
            prop_valueChangeListener.setShortDescription(resources.getString("HtmlInputTextarea_valueChangeListener_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("HtmlInputTextarea_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("HtmlInputTextarea_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("HtmlInputTextarea_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("HtmlInputTextarea_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("HtmlInputTextarea_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("HtmlInputTextarea_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("HtmlInputTextarea_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("HtmlInputTextarea_children_Description"));
            ...
            prop_converterMessage.setDisplayName(resources.getString("HtmlInputTextarea_converterMessage_DisplayName"));
            prop_converterMessage.setShortDescription(resources.getString("HtmlInputTextarea_converterMessage_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("HtmlInputTextarea_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("HtmlInputTextarea_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("HtmlInputTextarea_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("HtmlInputTextarea_family_Description"));
            ...
            prop_label.setDisplayName(resources.getString("HtmlInputTextarea_label_DisplayName"));
            prop_label.setShortDescription(resources.getString("HtmlInputTextarea_label_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("HtmlInputTextarea_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("HtmlInputTextarea_localValue_Description"));
            ...
            prop_localValueSet.setDisplayName(resources.getString("HtmlInputTextarea_localValueSet_DisplayName"));
            prop_localValueSet.setShortDescription(resources.getString("HtmlInputTextarea_localValueSet_Description"));
            ...
            prop_onblur.setDisplayName(resources.getString("HtmlInputTextarea_onblur_DisplayName"));
            prop_onblur.setShortDescription(resources.getString("HtmlInputTextarea_onblur_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("HtmlInputTextarea_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("HtmlInputTextarea_parent_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("HtmlInputTextarea_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("HtmlInputTextarea_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("HtmlInputTextarea_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("HtmlInputTextarea_rendersChildren_Description"));
            ...
            prop_submittedValue.setDisplayName(resources.getString("HtmlInputTextarea_submittedValue_DisplayName"));
            prop_submittedValue.setShortDescription(resources.getString("HtmlInputTextarea_submittedValue_Description"));
            ...
            prop_validatorMessage.setDisplayName(resources.getString("HtmlInputTextarea_validatorMessage_DisplayName"));
            prop_validatorMessage.setShortDescription(resources.getString("HtmlInputTextarea_validatorMessage_Description"));
