...
abstract class HtmlMessageBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("com.icesoft.faces.component.ext.Bundle-JSF", Locale.getDefault(), HtmlMessageBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>HtmlMessageBeanInfoBase</code>.</p>
     */
    public HtmlMessageBeanInfoBase() {

        beanClass = HtmlMessage.class;
        iconFileName_C16 = "HtmlMessage_C16";
        iconFileName_C32 = "HtmlMessage_C32";
        iconFileName_M16 = "HtmlMessage_M16";
        iconFileName_M32 = "HtmlMessage_M32";
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_dir.setDisplayName(resources.getString("HtmlMessage_dir_DisplayName"));
            prop_dir.setShortDescription(resources.getString("HtmlMessage_dir_Description"));
            ...
            prop_effect.setDisplayName(resources.getString("HtmlMessage_effect_DisplayName"));
            prop_effect.setShortDescription(resources.getString("HtmlMessage_effect_Description"));
            ...
            prop_escape.setDisplayName(resources.getString("HtmlMessage_escape_DisplayName"));
            prop_escape.setShortDescription(resources.getString("HtmlMessage_escape_Description"));
            ...
            prop_for.setDisplayName(resources.getString("HtmlMessage_for_DisplayName"));
            prop_for.setShortDescription(resources.getString("HtmlMessage_for_Description"));
            ...
            prop_for.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.APPEARANCE);

            PropertyDescriptor prop_id = new PropertyDescriptor("id",beanClass,"getId","setId");
            prop_id.setDisplayName(resources.getString("HtmlMessage_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("HtmlMessage_id_Description"));
            ...
            prop_lang.setDisplayName(resources.getString("HtmlMessage_lang_DisplayName"));
            prop_lang.setShortDescription(resources.getString("HtmlMessage_lang_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("HtmlMessage_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("HtmlMessage_rendered_Description"));
            ...
            prop_renderedOnUserRole.setDisplayName(resources.getString("HtmlMessage_renderedOnUserRole_DisplayName"));
            prop_renderedOnUserRole.setShortDescription(resources.getString("HtmlMessage_renderedOnUserRole_Description"));
            ...
            prop_showDetail.setDisplayName(resources.getString("HtmlMessage_showDetail_DisplayName"));
            prop_showDetail.setShortDescription(resources.getString("HtmlMessage_showDetail_Description"));
            ...
            prop_showSummary.setDisplayName(resources.getString("HtmlMessage_showSummary_DisplayName"));
            prop_showSummary.setShortDescription(resources.getString("HtmlMessage_showSummary_Description"));
            ...
            prop_style.setDisplayName(resources.getString("HtmlMessage_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("HtmlMessage_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("HtmlMessage_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("HtmlMessage_styleClass_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("HtmlMessage_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("HtmlMessage_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("HtmlMessage_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("HtmlMessage_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("HtmlMessage_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("HtmlMessage_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("HtmlMessage_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("HtmlMessage_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("HtmlMessage_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("HtmlMessage_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("HtmlMessage_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("HtmlMessage_family_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("HtmlMessage_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("HtmlMessage_parent_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("HtmlMessage_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("HtmlMessage_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("HtmlMessage_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("HtmlMessage_rendersChildren_Description"));
