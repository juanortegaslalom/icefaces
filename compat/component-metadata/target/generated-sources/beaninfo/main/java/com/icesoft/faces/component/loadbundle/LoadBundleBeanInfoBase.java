...
abstract class LoadBundleBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("com.icesoft.faces.component.loadbundle.Bundle-JSF", Locale.getDefault(), LoadBundleBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>LoadBundleBeanInfoBase</code>.</p>
     */
    public LoadBundleBeanInfoBase() {

        beanClass = LoadBundle.class;
        iconFileName_C16 = "LoadBundle_C16";
        iconFileName_C32 = "LoadBundle_C32";
        iconFileName_M16 = "LoadBundle_M16";
        iconFileName_M32 = "LoadBundle_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("LoadBundle_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("LoadBundle_Description"));
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_basename.setDisplayName(resources.getString("LoadBundle_basename_DisplayName"));
            prop_basename.setShortDescription(resources.getString("LoadBundle_basename_Description"));
            prop_basename.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.propertyeditors.StringPropertyEditor"));
            prop_basename.setExpert(false);
            prop_basename.setHidden(false);
            prop_basename.setPreferred(false);
            attrib = new AttributeDescriptor("basename",false,null,true);
            prop_basename.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_basename.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.GENERAL);

            PropertyDescriptor prop_id = new PropertyDescriptor("id",beanClass,"getId","setId");
            prop_id.setDisplayName(resources.getString("LoadBundle_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("LoadBundle_id_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("LoadBundle_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("LoadBundle_rendered_Description"));
            ...
            prop_var.setDisplayName(resources.getString("LoadBundle_var_DisplayName"));
            prop_var.setShortDescription(resources.getString("LoadBundle_var_Description"));
            ...
            prop_var.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.GENERAL);

            PropertyDescriptor prop_attributes = new PropertyDescriptor("attributes",beanClass,"getAttributes",null);
            prop_attributes.setDisplayName(resources.getString("LoadBundle_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("LoadBundle_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("LoadBundle_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("LoadBundle_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("LoadBundle_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("LoadBundle_children_Description"));
            ...
            prop_converter.setDisplayName(resources.getString("LoadBundle_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("LoadBundle_converter_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("LoadBundle_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("LoadBundle_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("LoadBundle_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("LoadBundle_family_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("LoadBundle_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("LoadBundle_localValue_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("LoadBundle_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("LoadBundle_parent_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("LoadBundle_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("LoadBundle_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("LoadBundle_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("LoadBundle_rendersChildren_Description"));
            ...
            prop_value.setDisplayName(resources.getString("LoadBundle_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("LoadBundle_value_Description"));
