...
abstract class TreeNodeBeanInfoBase extends SimpleBeanInfo {
    ...
    protected static ResourceBundle resources = ResourceBundle.getBundle("com.icesoft.faces.component.tree.Bundle-JSF", Locale.getDefault(), TreeNodeBeanInfoBase.class.getClassLoader());
    ...
    public TreeNodeBeanInfoBase() {
        ...
        beanClass = TreeNode.class;
        iconFileName_C16 = "TreeNode_C16";
        iconFileName_C32 = "TreeNode_C32";
        iconFileName_M16 = "TreeNode_M16";
        iconFileName_M32 = "TreeNode_M32";
