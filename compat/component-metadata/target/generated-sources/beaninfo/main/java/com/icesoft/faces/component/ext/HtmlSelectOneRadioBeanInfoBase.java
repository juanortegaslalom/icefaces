...
abstract class HtmlSelectOneRadioBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("com.icesoft.faces.component.ext.Bundle-JSF", Locale.getDefault(), HtmlSelectOneRadioBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>HtmlSelectOneRadioBeanInfoBase</code>.</p>
     */
    public HtmlSelectOneRadioBeanInfoBase() {

        beanClass = HtmlSelectOneRadio.class;
        iconFileName_C16 = "HtmlSelectOneRadio_C16";
        iconFileName_C32 = "HtmlSelectOneRadio_C32";
        iconFileName_M16 = "HtmlSelectOneRadio_M16";
        iconFileName_M32 = "HtmlSelectOneRadio_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"selectOneRadio");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_autocomplete.setDisplayName(resources.getString("HtmlSelectOneRadio_autocomplete_DisplayName"));
            prop_autocomplete.setShortDescription(resources.getString("HtmlSelectOneRadio_autocomplete_Description"));
            ...
            prop_converter.setDisplayName(resources.getString("HtmlSelectOneRadio_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("HtmlSelectOneRadio_converter_Description"));
            ...
            prop_effect.setDisplayName(resources.getString("HtmlSelectOneRadio_effect_DisplayName"));
            prop_effect.setShortDescription(resources.getString("HtmlSelectOneRadio_effect_Description"));
            ...
            prop_enabledOnUserRole.setDisplayName(resources.getString("HtmlSelectOneRadio_enabledOnUserRole_DisplayName"));
            prop_enabledOnUserRole.setShortDescription(resources.getString("HtmlSelectOneRadio_enabledOnUserRole_Description"));
            ...
            prop_id.setDisplayName(resources.getString("HtmlSelectOneRadio_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("HtmlSelectOneRadio_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("HtmlSelectOneRadio_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("HtmlSelectOneRadio_immediate_Description"));
            ...
            PropertyDescriptor prop_legend = new PropertyDescriptor("legend",beanClass,"getLegend","setLegend");
            prop_legend.setDisplayName(resources.getString("HtmlSelectOneRadio_legend_DisplayName"));
            prop_legend.setShortDescription(resources.getString("HtmlSelectOneRadio_legend_Description"));
            prop_legend.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.propertyeditors.StringPropertyEditor"));
            prop_legend.setExpert(false);
            prop_legend.setHidden(false);
            prop_legend.setPreferred(false);
            attrib = new AttributeDescriptor("legend",false,null,true);
            prop_legend.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_legend.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.APPEARANCE);

            PropertyDescriptor prop_onblur = new PropertyDescriptor("onblur",beanClass,"getOnblur","setOnblur");
            prop_onblur.setDisplayName(resources.getString("HtmlSelectOneRadio_onblur_DisplayName"));
            prop_onblur.setShortDescription(resources.getString("HtmlSelectOneRadio_onblur_Description"));
            ...
            prop_onchange.setDisplayName(resources.getString("HtmlSelectOneRadio_onchange_DisplayName"));
            prop_onchange.setShortDescription(resources.getString("HtmlSelectOneRadio_onchange_Description"));
            ...
            prop_onclick.setDisplayName(resources.getString("HtmlSelectOneRadio_onclick_DisplayName"));
            prop_onclick.setShortDescription(resources.getString("HtmlSelectOneRadio_onclick_Description"));
            ...
            prop_onclickeffect.setDisplayName(resources.getString("HtmlSelectOneRadio_onclickeffect_DisplayName"));
            prop_onclickeffect.setShortDescription(resources.getString("HtmlSelectOneRadio_onclickeffect_Description"));
            ...
            prop_ondblclick.setDisplayName(resources.getString("HtmlSelectOneRadio_ondblclick_DisplayName"));
            prop_ondblclick.setShortDescription(resources.getString("HtmlSelectOneRadio_ondblclick_Description"));
            ...
            prop_ondblclickeffect.setDisplayName(resources.getString("HtmlSelectOneRadio_ondblclickeffect_DisplayName"));
            prop_ondblclickeffect.setShortDescription(resources.getString("HtmlSelectOneRadio_ondblclickeffect_Description"));
            ...
            prop_onfocus.setDisplayName(resources.getString("HtmlSelectOneRadio_onfocus_DisplayName"));
            prop_onfocus.setShortDescription(resources.getString("HtmlSelectOneRadio_onfocus_Description"));
            ...
            prop_onkeydown.setDisplayName(resources.getString("HtmlSelectOneRadio_onkeydown_DisplayName"));
            prop_onkeydown.setShortDescription(resources.getString("HtmlSelectOneRadio_onkeydown_Description"));
            ...
            prop_onkeydowneffect.setDisplayName(resources.getString("HtmlSelectOneRadio_onkeydowneffect_DisplayName"));
            prop_onkeydowneffect.setShortDescription(resources.getString("HtmlSelectOneRadio_onkeydowneffect_Description"));
            ...
            prop_onkeypress.setDisplayName(resources.getString("HtmlSelectOneRadio_onkeypress_DisplayName"));
            prop_onkeypress.setShortDescription(resources.getString("HtmlSelectOneRadio_onkeypress_Description"));
            ...
            prop_onkeypresseffect.setDisplayName(resources.getString("HtmlSelectOneRadio_onkeypresseffect_DisplayName"));
            prop_onkeypresseffect.setShortDescription(resources.getString("HtmlSelectOneRadio_onkeypresseffect_Description"));
            ...
            prop_onkeyup.setDisplayName(resources.getString("HtmlSelectOneRadio_onkeyup_DisplayName"));
            prop_onkeyup.setShortDescription(resources.getString("HtmlSelectOneRadio_onkeyup_Description"));
            ...
            prop_onkeyupeffect.setDisplayName(resources.getString("HtmlSelectOneRadio_onkeyupeffect_DisplayName"));
            prop_onkeyupeffect.setShortDescription(resources.getString("HtmlSelectOneRadio_onkeyupeffect_Description"));
            ...
            prop_onmousedown.setDisplayName(resources.getString("HtmlSelectOneRadio_onmousedown_DisplayName"));
            prop_onmousedown.setShortDescription(resources.getString("HtmlSelectOneRadio_onmousedown_Description"));
            ...
            prop_onmousedowneffect.setDisplayName(resources.getString("HtmlSelectOneRadio_onmousedowneffect_DisplayName"));
            prop_onmousedowneffect.setShortDescription(resources.getString("HtmlSelectOneRadio_onmousedowneffect_Description"));
            ...
            prop_onmousemove.setDisplayName(resources.getString("HtmlSelectOneRadio_onmousemove_DisplayName"));
            prop_onmousemove.setShortDescription(resources.getString("HtmlSelectOneRadio_onmousemove_Description"));
            ...
            prop_onmousemoveeffect.setDisplayName(resources.getString("HtmlSelectOneRadio_onmousemoveeffect_DisplayName"));
            prop_onmousemoveeffect.setShortDescription(resources.getString("HtmlSelectOneRadio_onmousemoveeffect_Description"));
            ...
            prop_onmouseout.setDisplayName(resources.getString("HtmlSelectOneRadio_onmouseout_DisplayName"));
            prop_onmouseout.setShortDescription(resources.getString("HtmlSelectOneRadio_onmouseout_Description"));
            ...
            prop_onmouseouteffect.setDisplayName(resources.getString("HtmlSelectOneRadio_onmouseouteffect_DisplayName"));
            prop_onmouseouteffect.setShortDescription(resources.getString("HtmlSelectOneRadio_onmouseouteffect_Description"));
            ...
            prop_onmouseover.setDisplayName(resources.getString("HtmlSelectOneRadio_onmouseover_DisplayName"));
            prop_onmouseover.setShortDescription(resources.getString("HtmlSelectOneRadio_onmouseover_Description"));
            ...
            prop_onmouseovereffect.setDisplayName(resources.getString("HtmlSelectOneRadio_onmouseovereffect_DisplayName"));
            prop_onmouseovereffect.setShortDescription(resources.getString("HtmlSelectOneRadio_onmouseovereffect_Description"));
            ...
            prop_onmouseup.setDisplayName(resources.getString("HtmlSelectOneRadio_onmouseup_DisplayName"));
            prop_onmouseup.setShortDescription(resources.getString("HtmlSelectOneRadio_onmouseup_Description"));
            ...
            prop_onmouseupeffect.setDisplayName(resources.getString("HtmlSelectOneRadio_onmouseupeffect_DisplayName"));
            prop_onmouseupeffect.setShortDescription(resources.getString("HtmlSelectOneRadio_onmouseupeffect_Description"));
            ...
            prop_partialSubmit.setDisplayName(resources.getString("HtmlSelectOneRadio_partialSubmit_DisplayName"));
            prop_partialSubmit.setShortDescription(resources.getString("HtmlSelectOneRadio_partialSubmit_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("HtmlSelectOneRadio_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("HtmlSelectOneRadio_rendered_Description"));
            ...
            prop_renderedOnUserRole.setDisplayName(resources.getString("HtmlSelectOneRadio_renderedOnUserRole_DisplayName"));
            prop_renderedOnUserRole.setShortDescription(resources.getString("HtmlSelectOneRadio_renderedOnUserRole_Description"));
            ...
            prop_required.setDisplayName(resources.getString("HtmlSelectOneRadio_required_DisplayName"));
            prop_required.setShortDescription(resources.getString("HtmlSelectOneRadio_required_Description"));
            ...
            prop_requiredMessage.setDisplayName(resources.getString("HtmlSelectOneRadio_requiredMessage_DisplayName"));
            prop_requiredMessage.setShortDescription(resources.getString("HtmlSelectOneRadio_requiredMessage_Description"));
            ...
            prop_style.setDisplayName(resources.getString("HtmlSelectOneRadio_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("HtmlSelectOneRadio_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("HtmlSelectOneRadio_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("HtmlSelectOneRadio_styleClass_Description"));
            ...
            prop_validator.setDisplayName(resources.getString("HtmlSelectOneRadio_validator_DisplayName"));
            prop_validator.setShortDescription(resources.getString("HtmlSelectOneRadio_validator_Description"));
            ...
            prop_value.setDisplayName(resources.getString("HtmlSelectOneRadio_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("HtmlSelectOneRadio_value_Description"));
            ...
            prop_valueChangeListener.setDisplayName(resources.getString("HtmlSelectOneRadio_valueChangeListener_DisplayName"));
            prop_valueChangeListener.setShortDescription(resources.getString("HtmlSelectOneRadio_valueChangeListener_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("HtmlSelectOneRadio_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("HtmlSelectOneRadio_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("HtmlSelectOneRadio_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("HtmlSelectOneRadio_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("HtmlSelectOneRadio_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("HtmlSelectOneRadio_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("HtmlSelectOneRadio_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("HtmlSelectOneRadio_children_Description"));
            ...
            prop_converterMessage.setDisplayName(resources.getString("HtmlSelectOneRadio_converterMessage_DisplayName"));
            prop_converterMessage.setShortDescription(resources.getString("HtmlSelectOneRadio_converterMessage_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("HtmlSelectOneRadio_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("HtmlSelectOneRadio_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("HtmlSelectOneRadio_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("HtmlSelectOneRadio_family_Description"));
            ...
            prop_label.setDisplayName(resources.getString("HtmlSelectOneRadio_label_DisplayName"));
            prop_label.setShortDescription(resources.getString("HtmlSelectOneRadio_label_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("HtmlSelectOneRadio_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("HtmlSelectOneRadio_localValue_Description"));
            ...
            prop_localValueSet.setDisplayName(resources.getString("HtmlSelectOneRadio_localValueSet_DisplayName"));
            prop_localValueSet.setShortDescription(resources.getString("HtmlSelectOneRadio_localValueSet_Description"));
            ...
            prop_onselect.setDisplayName(resources.getString("HtmlSelectOneRadio_onselect_DisplayName"));
            prop_onselect.setShortDescription(resources.getString("HtmlSelectOneRadio_onselect_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("HtmlSelectOneRadio_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("HtmlSelectOneRadio_parent_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("HtmlSelectOneRadio_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("HtmlSelectOneRadio_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("HtmlSelectOneRadio_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("HtmlSelectOneRadio_rendersChildren_Description"));
            ...
            prop_submittedValue.setDisplayName(resources.getString("HtmlSelectOneRadio_submittedValue_DisplayName"));
            prop_submittedValue.setShortDescription(resources.getString("HtmlSelectOneRadio_submittedValue_Description"));
            ...
            prop_validatorMessage.setDisplayName(resources.getString("HtmlSelectOneRadio_validatorMessage_DisplayName"));
            prop_validatorMessage.setShortDescription(resources.getString("HtmlSelectOneRadio_validatorMessage_Description"));
