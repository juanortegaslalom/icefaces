...
abstract class HtmlOutputTextBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("com.icesoft.faces.component.ext.Bundle-JSF", Locale.getDefault(), HtmlOutputTextBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>HtmlOutputTextBeanInfoBase</code>.</p>
     */
    public HtmlOutputTextBeanInfoBase() {

        beanClass = HtmlOutputText.class;
        iconFileName_C16 = "HtmlOutputText_C16";
        iconFileName_C32 = "HtmlOutputText_C32";
        iconFileName_M16 = "HtmlOutputText_M16";
        iconFileName_M32 = "HtmlOutputText_M32";
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_converter.setDisplayName(resources.getString("HtmlOutputText_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("HtmlOutputText_converter_Description"));
            ...
            prop_dir.setDisplayName(resources.getString("HtmlOutputText_dir_DisplayName"));
            prop_dir.setShortDescription(resources.getString("HtmlOutputText_dir_Description"));
            ...
            prop_effect.setDisplayName(resources.getString("HtmlOutputText_effect_DisplayName"));
            prop_effect.setShortDescription(resources.getString("HtmlOutputText_effect_Description"));
            ...
            prop_id.setDisplayName(resources.getString("HtmlOutputText_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("HtmlOutputText_id_Description"));
            ...
            prop_lang.setDisplayName(resources.getString("HtmlOutputText_lang_DisplayName"));
            prop_lang.setShortDescription(resources.getString("HtmlOutputText_lang_Description"));
            ...
            PropertyDescriptor prop_nospan = new PropertyDescriptor("nospan",beanClass,"isNospan","setNospan");
            prop_nospan.setDisplayName(resources.getString("HtmlOutputText_nospan_DisplayName"));
            prop_nospan.setShortDescription(resources.getString("HtmlOutputText_nospan_Description"));
            prop_nospan.setExpert(false);
            prop_nospan.setHidden(false);
            prop_nospan.setPreferred(false);
            attrib = new AttributeDescriptor("nospan",false,"false",true);
            prop_nospan.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_nospan.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.ICE_LAYOUT);

            PropertyDescriptor prop_onclick = new PropertyDescriptor("onclick",beanClass,"getOnclick","setOnclick");
            prop_onclick.setDisplayName(resources.getString("HtmlOutputText_onclick_DisplayName"));
            prop_onclick.setShortDescription(resources.getString("HtmlOutputText_onclick_Description"));
            ...
            prop_onclickeffect.setDisplayName(resources.getString("HtmlOutputText_onclickeffect_DisplayName"));
            prop_onclickeffect.setShortDescription(resources.getString("HtmlOutputText_onclickeffect_Description"));
            ...
            prop_ondblclick.setDisplayName(resources.getString("HtmlOutputText_ondblclick_DisplayName"));
            prop_ondblclick.setShortDescription(resources.getString("HtmlOutputText_ondblclick_Description"));
            ...
            prop_ondblclickeffect.setDisplayName(resources.getString("HtmlOutputText_ondblclickeffect_DisplayName"));
            prop_ondblclickeffect.setShortDescription(resources.getString("HtmlOutputText_ondblclickeffect_Description"));
            ...
            prop_onkeydown.setDisplayName(resources.getString("HtmlOutputText_onkeydown_DisplayName"));
            prop_onkeydown.setShortDescription(resources.getString("HtmlOutputText_onkeydown_Description"));
            ...
            prop_onkeydowneffect.setDisplayName(resources.getString("HtmlOutputText_onkeydowneffect_DisplayName"));
            prop_onkeydowneffect.setShortDescription(resources.getString("HtmlOutputText_onkeydowneffect_Description"));
            ...
            prop_onkeypress.setDisplayName(resources.getString("HtmlOutputText_onkeypress_DisplayName"));
            prop_onkeypress.setShortDescription(resources.getString("HtmlOutputText_onkeypress_Description"));
            ...
            prop_onkeypresseffect.setDisplayName(resources.getString("HtmlOutputText_onkeypresseffect_DisplayName"));
            prop_onkeypresseffect.setShortDescription(resources.getString("HtmlOutputText_onkeypresseffect_Description"));
            ...
            prop_onkeyup.setDisplayName(resources.getString("HtmlOutputText_onkeyup_DisplayName"));
            prop_onkeyup.setShortDescription(resources.getString("HtmlOutputText_onkeyup_Description"));
            ...
            prop_onkeyupeffect.setDisplayName(resources.getString("HtmlOutputText_onkeyupeffect_DisplayName"));
            prop_onkeyupeffect.setShortDescription(resources.getString("HtmlOutputText_onkeyupeffect_Description"));
            ...
            prop_onmousedown.setDisplayName(resources.getString("HtmlOutputText_onmousedown_DisplayName"));
            prop_onmousedown.setShortDescription(resources.getString("HtmlOutputText_onmousedown_Description"));
            ...
            prop_onmousedowneffect.setDisplayName(resources.getString("HtmlOutputText_onmousedowneffect_DisplayName"));
            prop_onmousedowneffect.setShortDescription(resources.getString("HtmlOutputText_onmousedowneffect_Description"));
            ...
            prop_onmousemove.setDisplayName(resources.getString("HtmlOutputText_onmousemove_DisplayName"));
            prop_onmousemove.setShortDescription(resources.getString("HtmlOutputText_onmousemove_Description"));
            ...
            prop_onmousemoveeffect.setDisplayName(resources.getString("HtmlOutputText_onmousemoveeffect_DisplayName"));
            prop_onmousemoveeffect.setShortDescription(resources.getString("HtmlOutputText_onmousemoveeffect_Description"));
            ...
            prop_onmouseout.setDisplayName(resources.getString("HtmlOutputText_onmouseout_DisplayName"));
            prop_onmouseout.setShortDescription(resources.getString("HtmlOutputText_onmouseout_Description"));
            ...
            prop_onmouseouteffect.setDisplayName(resources.getString("HtmlOutputText_onmouseouteffect_DisplayName"));
            prop_onmouseouteffect.setShortDescription(resources.getString("HtmlOutputText_onmouseouteffect_Description"));
            ...
            prop_onmouseover.setDisplayName(resources.getString("HtmlOutputText_onmouseover_DisplayName"));
            prop_onmouseover.setShortDescription(resources.getString("HtmlOutputText_onmouseover_Description"));
            ...
            prop_onmouseovereffect.setDisplayName(resources.getString("HtmlOutputText_onmouseovereffect_DisplayName"));
            prop_onmouseovereffect.setShortDescription(resources.getString("HtmlOutputText_onmouseovereffect_Description"));
            ...
            prop_onmouseup.setDisplayName(resources.getString("HtmlOutputText_onmouseup_DisplayName"));
            prop_onmouseup.setShortDescription(resources.getString("HtmlOutputText_onmouseup_Description"));
            ...
            prop_onmouseupeffect.setDisplayName(resources.getString("HtmlOutputText_onmouseupeffect_DisplayName"));
            prop_onmouseupeffect.setShortDescription(resources.getString("HtmlOutputText_onmouseupeffect_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("HtmlOutputText_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("HtmlOutputText_rendered_Description"));
            ...
            prop_renderedOnUserRole.setDisplayName(resources.getString("HtmlOutputText_renderedOnUserRole_DisplayName"));
            prop_renderedOnUserRole.setShortDescription(resources.getString("HtmlOutputText_renderedOnUserRole_Description"));
            ...
            prop_style.setDisplayName(resources.getString("HtmlOutputText_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("HtmlOutputText_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("HtmlOutputText_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("HtmlOutputText_styleClass_Description"));
            ...
            prop_value.setDisplayName(resources.getString("HtmlOutputText_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("HtmlOutputText_value_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("HtmlOutputText_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("HtmlOutputText_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("HtmlOutputText_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("HtmlOutputText_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("HtmlOutputText_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("HtmlOutputText_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("HtmlOutputText_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("HtmlOutputText_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("HtmlOutputText_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("HtmlOutputText_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("HtmlOutputText_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("HtmlOutputText_family_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("HtmlOutputText_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("HtmlOutputText_localValue_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("HtmlOutputText_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("HtmlOutputText_parent_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("HtmlOutputText_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("HtmlOutputText_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("HtmlOutputText_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("HtmlOutputText_rendersChildren_Description"));
