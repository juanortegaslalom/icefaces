...
abstract class RepeatBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("com.icesoft.faces.component.repeat.Bundle-JSF", Locale.getDefault(), RepeatBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>RepeatBeanInfoBase</code>.</p>
     */
    public RepeatBeanInfoBase() {

        beanClass = Repeat.class;
        iconFileName_C16 = "Repeat_C16";
        iconFileName_C32 = "Repeat_C32";
        iconFileName_M16 = "Repeat_M16";
        iconFileName_M32 = "Repeat_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("Repeat_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("Repeat_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"repeat");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.MARKUP_SECTION,"form");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"repeat");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_first.setDisplayName(resources.getString("Repeat_first_DisplayName"));
            prop_first.setShortDescription(resources.getString("Repeat_first_Description"));
            ...
            prop_id.setDisplayName(resources.getString("Repeat_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("Repeat_id_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("Repeat_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("Repeat_rendered_Description"));
            ...
            prop_rows.setDisplayName(resources.getString("Repeat_rows_DisplayName"));
            prop_rows.setShortDescription(resources.getString("Repeat_rows_Description"));
            ...
            prop_value.setDisplayName(resources.getString("Repeat_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("Repeat_value_Description"));
            ...
            prop_var.setDisplayName(resources.getString("Repeat_var_DisplayName"));
            prop_var.setShortDescription(resources.getString("Repeat_var_Description"));
            ...
            prop_varStatus.setDisplayName(resources.getString("Repeat_varStatus_DisplayName"));
            prop_varStatus.setShortDescription(resources.getString("Repeat_varStatus_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("Repeat_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("Repeat_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("Repeat_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("Repeat_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("Repeat_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("Repeat_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("Repeat_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("Repeat_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("Repeat_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("Repeat_family_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("Repeat_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("Repeat_parent_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("Repeat_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("Repeat_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("Repeat_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("Repeat_rendersChildren_Description"));
            ...
            prop_rowAvailable.setDisplayName(resources.getString("Repeat_rowAvailable_DisplayName"));
            prop_rowAvailable.setShortDescription(resources.getString("Repeat_rowAvailable_Description"));
            ...
            prop_rowCount.setDisplayName(resources.getString("Repeat_rowCount_DisplayName"));
            prop_rowCount.setShortDescription(resources.getString("Repeat_rowCount_Description"));
            ...
            prop_rowData.setDisplayName(resources.getString("Repeat_rowData_DisplayName"));
            prop_rowData.setShortDescription(resources.getString("Repeat_rowData_Description"));
            ...
            prop_rowIndex.setDisplayName(resources.getString("Repeat_rowIndex_DisplayName"));
            prop_rowIndex.setShortDescription(resources.getString("Repeat_rowIndex_Description"));
            ...
            prop_rowStatePreserved.setDisplayName(resources.getString("Repeat_rowStatePreserved_DisplayName"));
            prop_rowStatePreserved.setShortDescription(resources.getString("Repeat_rowStatePreserved_Description"));
