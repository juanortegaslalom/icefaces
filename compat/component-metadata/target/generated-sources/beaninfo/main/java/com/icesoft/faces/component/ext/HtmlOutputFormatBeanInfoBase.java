...
abstract class HtmlOutputFormatBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("com.icesoft.faces.component.ext.Bundle-JSF", Locale.getDefault(), HtmlOutputFormatBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>HtmlOutputFormatBeanInfoBase</code>.</p>
     */
    public HtmlOutputFormatBeanInfoBase() {

        beanClass = HtmlOutputFormat.class;
        iconFileName_C16 = "HtmlOutputFormat_C16";
        iconFileName_C32 = "HtmlOutputFormat_C32";
        iconFileName_M16 = "HtmlOutputFormat_M16";
        iconFileName_M32 = "HtmlOutputFormat_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"outputFormat");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_converter.setDisplayName(resources.getString("HtmlOutputFormat_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("HtmlOutputFormat_converter_Description"));
            ...
            prop_dir.setDisplayName(resources.getString("HtmlOutputFormat_dir_DisplayName"));
            prop_dir.setShortDescription(resources.getString("HtmlOutputFormat_dir_Description"));
            ...
            prop_id.setDisplayName(resources.getString("HtmlOutputFormat_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("HtmlOutputFormat_id_Description"));
            ...
            prop_lang.setDisplayName(resources.getString("HtmlOutputFormat_lang_DisplayName"));
            prop_lang.setShortDescription(resources.getString("HtmlOutputFormat_lang_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("HtmlOutputFormat_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("HtmlOutputFormat_rendered_Description"));
            ...
            prop_style.setDisplayName(resources.getString("HtmlOutputFormat_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("HtmlOutputFormat_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("HtmlOutputFormat_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("HtmlOutputFormat_styleClass_Description"));
            ...
            prop_value.setDisplayName(resources.getString("HtmlOutputFormat_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("HtmlOutputFormat_value_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("HtmlOutputFormat_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("HtmlOutputFormat_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("HtmlOutputFormat_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("HtmlOutputFormat_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("HtmlOutputFormat_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("HtmlOutputFormat_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("HtmlOutputFormat_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("HtmlOutputFormat_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("HtmlOutputFormat_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("HtmlOutputFormat_family_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("HtmlOutputFormat_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("HtmlOutputFormat_localValue_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("HtmlOutputFormat_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("HtmlOutputFormat_parent_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("HtmlOutputFormat_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("HtmlOutputFormat_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("HtmlOutputFormat_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("HtmlOutputFormat_rendersChildren_Description"));
