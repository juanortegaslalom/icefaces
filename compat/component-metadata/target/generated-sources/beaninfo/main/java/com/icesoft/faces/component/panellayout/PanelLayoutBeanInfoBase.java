...
abstract class PanelLayoutBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("com.icesoft.faces.component.panellayout.Bundle-JSF", Locale.getDefault(), PanelLayoutBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>PanelLayoutBeanInfoBase</code>.</p>
     */
    public PanelLayoutBeanInfoBase() {

        beanClass = PanelLayout.class;
        iconFileName_C16 = "PanelLayout_C16";
        iconFileName_C32 = "PanelLayout_C32";
        iconFileName_M16 = "PanelLayout_M16";
        iconFileName_M32 = "PanelLayout_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("PanelLayout_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("PanelLayout_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"panelLayout");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.MARKUP_SECTION,"form");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"panelLayout");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_id.setDisplayName(resources.getString("PanelLayout_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("PanelLayout_id_Description"));
            ...
            prop_layout.setDisplayName(resources.getString("PanelLayout_layout_DisplayName"));
            prop_layout.setShortDescription(resources.getString("PanelLayout_layout_Description"));
            ...
            attrib = new AttributeDescriptor("layout",false,"\"absolute\"",true);
            prop_layout.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_layout.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.ADVANCED);

            PropertyDescriptor prop_rendered = new PropertyDescriptor("rendered",beanClass,"isRendered","setRendered");
            prop_rendered.setDisplayName(resources.getString("PanelLayout_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("PanelLayout_rendered_Description"));
            ...
            prop_renderedOnUserRole.setDisplayName(resources.getString("PanelLayout_renderedOnUserRole_DisplayName"));
            prop_renderedOnUserRole.setShortDescription(resources.getString("PanelLayout_renderedOnUserRole_Description"));
            ...
            prop_style.setDisplayName(resources.getString("PanelLayout_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("PanelLayout_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("PanelLayout_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("PanelLayout_styleClass_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("PanelLayout_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("PanelLayout_visible_Description"));
            prop_visible.setExpert(false);
            prop_visible.setHidden(false);
            prop_visible.setPreferred(false);
            attrib = new AttributeDescriptor("visible",false,"false",true);
            ...
            prop_attributes.setDisplayName(resources.getString("PanelLayout_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("PanelLayout_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("PanelLayout_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("PanelLayout_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("PanelLayout_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("PanelLayout_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("PanelLayout_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("PanelLayout_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("PanelLayout_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("PanelLayout_family_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("PanelLayout_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("PanelLayout_parent_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("PanelLayout_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("PanelLayout_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("PanelLayout_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("PanelLayout_rendersChildren_Description"));
