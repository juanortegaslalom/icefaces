...
abstract class HtmlCommandButtonBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("com.icesoft.faces.component.ext.Bundle-JSF", Locale.getDefault(), HtmlCommandButtonBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>HtmlCommandButtonBeanInfoBase</code>.</p>
     */
    public HtmlCommandButtonBeanInfoBase() {

        beanClass = HtmlCommandButton.class;
        iconFileName_C16 = "HtmlCommandButton_C16";
        iconFileName_C32 = "HtmlCommandButton_C32";
        iconFileName_M16 = "HtmlCommandButton_M16";
        iconFileName_M32 = "HtmlCommandButton_M32";
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_action.setDisplayName(resources.getString("HtmlCommandButton_action_DisplayName"));
            prop_action.setShortDescription(resources.getString("HtmlCommandButton_action_Description"));
            ...
            prop_actionListener.setDisplayName(resources.getString("HtmlCommandButton_actionListener_DisplayName"));
            prop_actionListener.setShortDescription(resources.getString("HtmlCommandButton_actionListener_Description"));
            ...
            prop_effect.setDisplayName(resources.getString("HtmlCommandButton_effect_DisplayName"));
            prop_effect.setShortDescription(resources.getString("HtmlCommandButton_effect_Description"));
            ...
            prop_enabledOnUserRole.setDisplayName(resources.getString("HtmlCommandButton_enabledOnUserRole_DisplayName"));
            prop_enabledOnUserRole.setShortDescription(resources.getString("HtmlCommandButton_enabledOnUserRole_Description"));
            ...
            prop_id.setDisplayName(resources.getString("HtmlCommandButton_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("HtmlCommandButton_id_Description"));
            ...
            prop_image.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.propertyeditors.UrlPropertyEditor"));
            ...
            prop_image.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.APPEARANCE);

            PropertyDescriptor prop_immediate = new PropertyDescriptor("immediate",beanClass,"isImmediate","setImmediate");
            prop_immediate.setDisplayName(resources.getString("HtmlCommandButton_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("HtmlCommandButton_immediate_Description"));
            ...
            prop_onblur.setDisplayName(resources.getString("HtmlCommandButton_onblur_DisplayName"));
            prop_onblur.setShortDescription(resources.getString("HtmlCommandButton_onblur_Description"));
            ...
            prop_onchange.setDisplayName(resources.getString("HtmlCommandButton_onchange_DisplayName"));
            prop_onchange.setShortDescription(resources.getString("HtmlCommandButton_onchange_Description"));
            ...
            prop_onclick.setDisplayName(resources.getString("HtmlCommandButton_onclick_DisplayName"));
            prop_onclick.setShortDescription(resources.getString("HtmlCommandButton_onclick_Description"));
            ...
            prop_onclickeffect.setDisplayName(resources.getString("HtmlCommandButton_onclickeffect_DisplayName"));
            prop_onclickeffect.setShortDescription(resources.getString("HtmlCommandButton_onclickeffect_Description"));
            ...
            prop_ondblclick.setDisplayName(resources.getString("HtmlCommandButton_ondblclick_DisplayName"));
            prop_ondblclick.setShortDescription(resources.getString("HtmlCommandButton_ondblclick_Description"));
            ...
            prop_ondblclickeffect.setDisplayName(resources.getString("HtmlCommandButton_ondblclickeffect_DisplayName"));
            prop_ondblclickeffect.setShortDescription(resources.getString("HtmlCommandButton_ondblclickeffect_Description"));
            ...
            prop_onfocus.setDisplayName(resources.getString("HtmlCommandButton_onfocus_DisplayName"));
            prop_onfocus.setShortDescription(resources.getString("HtmlCommandButton_onfocus_Description"));
            ...
            prop_onkeydown.setDisplayName(resources.getString("HtmlCommandButton_onkeydown_DisplayName"));
            prop_onkeydown.setShortDescription(resources.getString("HtmlCommandButton_onkeydown_Description"));
            ...
            prop_onkeydowneffect.setDisplayName(resources.getString("HtmlCommandButton_onkeydowneffect_DisplayName"));
            prop_onkeydowneffect.setShortDescription(resources.getString("HtmlCommandButton_onkeydowneffect_Description"));
            ...
            prop_onkeypress.setDisplayName(resources.getString("HtmlCommandButton_onkeypress_DisplayName"));
            prop_onkeypress.setShortDescription(resources.getString("HtmlCommandButton_onkeypress_Description"));
            ...
            prop_onkeypresseffect.setDisplayName(resources.getString("HtmlCommandButton_onkeypresseffect_DisplayName"));
            prop_onkeypresseffect.setShortDescription(resources.getString("HtmlCommandButton_onkeypresseffect_Description"));
            ...
            prop_onkeyup.setDisplayName(resources.getString("HtmlCommandButton_onkeyup_DisplayName"));
            prop_onkeyup.setShortDescription(resources.getString("HtmlCommandButton_onkeyup_Description"));
            ...
            prop_onkeyupeffect.setDisplayName(resources.getString("HtmlCommandButton_onkeyupeffect_DisplayName"));
            prop_onkeyupeffect.setShortDescription(resources.getString("HtmlCommandButton_onkeyupeffect_Description"));
            ...
            prop_onmousedown.setDisplayName(resources.getString("HtmlCommandButton_onmousedown_DisplayName"));
            prop_onmousedown.setShortDescription(resources.getString("HtmlCommandButton_onmousedown_Description"));
            ...
            prop_onmousedowneffect.setDisplayName(resources.getString("HtmlCommandButton_onmousedowneffect_DisplayName"));
            prop_onmousedowneffect.setShortDescription(resources.getString("HtmlCommandButton_onmousedowneffect_Description"));
            ...
            prop_onmousemove.setDisplayName(resources.getString("HtmlCommandButton_onmousemove_DisplayName"));
            prop_onmousemove.setShortDescription(resources.getString("HtmlCommandButton_onmousemove_Description"));
            ...
            prop_onmousemoveeffect.setDisplayName(resources.getString("HtmlCommandButton_onmousemoveeffect_DisplayName"));
            prop_onmousemoveeffect.setShortDescription(resources.getString("HtmlCommandButton_onmousemoveeffect_Description"));
            ...
            prop_onmouseout.setDisplayName(resources.getString("HtmlCommandButton_onmouseout_DisplayName"));
            prop_onmouseout.setShortDescription(resources.getString("HtmlCommandButton_onmouseout_Description"));
            ...
            prop_onmouseouteffect.setDisplayName(resources.getString("HtmlCommandButton_onmouseouteffect_DisplayName"));
            prop_onmouseouteffect.setShortDescription(resources.getString("HtmlCommandButton_onmouseouteffect_Description"));
            ...
            prop_onmouseover.setDisplayName(resources.getString("HtmlCommandButton_onmouseover_DisplayName"));
            prop_onmouseover.setShortDescription(resources.getString("HtmlCommandButton_onmouseover_Description"));
            ...
            prop_onmouseovereffect.setDisplayName(resources.getString("HtmlCommandButton_onmouseovereffect_DisplayName"));
            prop_onmouseovereffect.setShortDescription(resources.getString("HtmlCommandButton_onmouseovereffect_Description"));
            ...
            prop_onmouseup.setDisplayName(resources.getString("HtmlCommandButton_onmouseup_DisplayName"));
            prop_onmouseup.setShortDescription(resources.getString("HtmlCommandButton_onmouseup_Description"));
            ...
            prop_onmouseupeffect.setDisplayName(resources.getString("HtmlCommandButton_onmouseupeffect_DisplayName"));
            prop_onmouseupeffect.setShortDescription(resources.getString("HtmlCommandButton_onmouseupeffect_Description"));
            ...
            prop_onselect.setDisplayName(resources.getString("HtmlCommandButton_onselect_DisplayName"));
            prop_onselect.setShortDescription(resources.getString("HtmlCommandButton_onselect_Description"));
            ...
            prop_panelConfirmation.setDisplayName(resources.getString("HtmlCommandButton_panelConfirmation_DisplayName"));
            prop_panelConfirmation.setShortDescription(resources.getString("HtmlCommandButton_panelConfirmation_Description"));
            prop_panelConfirmation.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.propertyeditors.SelectOneDomainEditor"));
            prop_panelConfirmation.setExpert(false);
            prop_panelConfirmation.setHidden(false);
            prop_panelConfirmation.setPreferred(false);
            attrib = new AttributeDescriptor("panelConfirmation",false,null,true);
            prop_panelConfirmation.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_panelConfirmation.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.GENERAL);
            prop_panelConfirmation.setValue("com.sun.rave.propertyeditors.DOMAIN_CLASS", com.sun.rave.propertyeditors.domains.InputComponentIdsDomain.class);

            PropertyDescriptor prop_partialSubmit = new PropertyDescriptor("partialSubmit",beanClass,"isPartialSubmit","setPartialSubmit");
            prop_partialSubmit.setDisplayName(resources.getString("HtmlCommandButton_partialSubmit_DisplayName"));
            prop_partialSubmit.setShortDescription(resources.getString("HtmlCommandButton_partialSubmit_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("HtmlCommandButton_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("HtmlCommandButton_rendered_Description"));
            ...
            prop_renderedOnUserRole.setDisplayName(resources.getString("HtmlCommandButton_renderedOnUserRole_DisplayName"));
            prop_renderedOnUserRole.setShortDescription(resources.getString("HtmlCommandButton_renderedOnUserRole_Description"));
            ...
            prop_style.setDisplayName(resources.getString("HtmlCommandButton_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("HtmlCommandButton_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("HtmlCommandButton_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("HtmlCommandButton_styleClass_Description"));
            ...
            prop_type.setValue("com.sun.rave.propertyeditors.DOMAIN_CLASS", com.icesoft.faces.ide.vwp.propertyeditors.HtmlCommandButtonTypesDomain.class);

            PropertyDescriptor prop_value = new PropertyDescriptor("value",beanClass,"getValue","setValue");
            prop_value.setDisplayName(resources.getString("HtmlCommandButton_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("HtmlCommandButton_value_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("HtmlCommandButton_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("HtmlCommandButton_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("HtmlCommandButton_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("HtmlCommandButton_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("HtmlCommandButton_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("HtmlCommandButton_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("HtmlCommandButton_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("HtmlCommandButton_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("HtmlCommandButton_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("HtmlCommandButton_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("HtmlCommandButton_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("HtmlCommandButton_family_Description"));
            ...
            prop_label.setDisplayName(resources.getString("HtmlCommandButton_label_DisplayName"));
            prop_label.setShortDescription(resources.getString("HtmlCommandButton_label_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("HtmlCommandButton_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("HtmlCommandButton_parent_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("HtmlCommandButton_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("HtmlCommandButton_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("HtmlCommandButton_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("HtmlCommandButton_rendersChildren_Description"));
