...
abstract class SelectInputTextBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("com.icesoft.faces.component.selectinputtext.Bundle-JSF", Locale.getDefault(), SelectInputTextBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>SelectInputTextBeanInfoBase</code>.</p>
     */
    public SelectInputTextBeanInfoBase() {

        beanClass = SelectInputText.class;
        iconFileName_C16 = "SelectInputText_C16";
        iconFileName_C32 = "SelectInputText_C32";
        iconFileName_M16 = "SelectInputText_M16";
        iconFileName_M32 = "SelectInputText_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("SelectInputText_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("SelectInputText_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"selectInputText");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.MARKUP_SECTION,"form");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"selectInputText");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_accesskey.setDisplayName(resources.getString("SelectInputText_accesskey_DisplayName"));
            prop_accesskey.setShortDescription(resources.getString("SelectInputText_accesskey_Description"));
            ...
            prop_action.setDisplayName(resources.getString("SelectInputText_action_DisplayName"));
            prop_action.setShortDescription(resources.getString("SelectInputText_action_Description"));
            ...
            prop_actionListener.setDisplayName(resources.getString("SelectInputText_actionListener_DisplayName"));
            prop_actionListener.setShortDescription(resources.getString("SelectInputText_actionListener_Description"));
            ...
            prop_alt.setDisplayName(resources.getString("SelectInputText_alt_DisplayName"));
            prop_alt.setShortDescription(resources.getString("SelectInputText_alt_Description"));
            ...
            prop_autocomplete.setDisplayName(resources.getString("SelectInputText_autocomplete_DisplayName"));
            prop_autocomplete.setShortDescription(resources.getString("SelectInputText_autocomplete_Description"));
            ...
            prop_converter.setDisplayName(resources.getString("SelectInputText_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("SelectInputText_converter_Description"));
            ...
            prop_dir.setDisplayName(resources.getString("SelectInputText_dir_DisplayName"));
            prop_dir.setShortDescription(resources.getString("SelectInputText_dir_Description"));
            ...
            prop_disabled.setDisplayName(resources.getString("SelectInputText_disabled_DisplayName"));
            prop_disabled.setShortDescription(resources.getString("SelectInputText_disabled_Description"));
            ...
            prop_effect.setDisplayName(resources.getString("SelectInputText_effect_DisplayName"));
            prop_effect.setShortDescription(resources.getString("SelectInputText_effect_Description"));
            ...
            prop_enabledOnUserRole.setDisplayName(resources.getString("SelectInputText_enabledOnUserRole_DisplayName"));
            prop_enabledOnUserRole.setShortDescription(resources.getString("SelectInputText_enabledOnUserRole_Description"));
            ...
            prop_id.setDisplayName(resources.getString("SelectInputText_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("SelectInputText_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("SelectInputText_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("SelectInputText_immediate_Description"));
            ...
            prop_lang.setDisplayName(resources.getString("SelectInputText_lang_DisplayName"));
            prop_lang.setShortDescription(resources.getString("SelectInputText_lang_Description"));
            ...
            PropertyDescriptor prop_listValue = new PropertyDescriptor("listValue",beanClass,"getListValue","setListValue");
            prop_listValue.setDisplayName(resources.getString("SelectInputText_listValue_DisplayName"));
            prop_listValue.setShortDescription(resources.getString("SelectInputText_listValue_Description"));
            prop_listValue.setExpert(false);
            prop_listValue.setHidden(false);
            prop_listValue.setPreferred(false);
            attrib = new AttributeDescriptor("listValue",false,null,true);
            prop_listValue.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_listValue.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.ICE_LAYOUT);

            PropertyDescriptor prop_listVar = new PropertyDescriptor("listVar",beanClass,"getListVar","setListVar");
            prop_listVar.setDisplayName(resources.getString("SelectInputText_listVar_DisplayName"));
            prop_listVar.setShortDescription(resources.getString("SelectInputText_listVar_Description"));
            prop_listVar.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.faces.dt.std.ValueBindingPropertyEditor"));
            prop_listVar.setExpert(false);
            prop_listVar.setHidden(false);
            prop_listVar.setPreferred(false);
            attrib = new AttributeDescriptor("listVar",false,null,true);
            prop_listVar.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_listVar.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.ICE_LAYOUT);

            PropertyDescriptor prop_maxlength = new PropertyDescriptor("maxlength",beanClass,"getMaxlength","setMaxlength");
            prop_maxlength.setDisplayName(resources.getString("SelectInputText_maxlength_DisplayName"));
            prop_maxlength.setShortDescription(resources.getString("SelectInputText_maxlength_Description"));
            ...
            prop_onchange.setDisplayName(resources.getString("SelectInputText_onchange_DisplayName"));
            prop_onchange.setShortDescription(resources.getString("SelectInputText_onchange_Description"));
            ...
            prop_onclick.setDisplayName(resources.getString("SelectInputText_onclick_DisplayName"));
            prop_onclick.setShortDescription(resources.getString("SelectInputText_onclick_Description"));
            ...
            prop_onclickeffect.setDisplayName(resources.getString("SelectInputText_onclickeffect_DisplayName"));
            prop_onclickeffect.setShortDescription(resources.getString("SelectInputText_onclickeffect_Description"));
            ...
            prop_ondblclick.setDisplayName(resources.getString("SelectInputText_ondblclick_DisplayName"));
            prop_ondblclick.setShortDescription(resources.getString("SelectInputText_ondblclick_Description"));
            ...
            prop_ondblclickeffect.setDisplayName(resources.getString("SelectInputText_ondblclickeffect_DisplayName"));
            prop_ondblclickeffect.setShortDescription(resources.getString("SelectInputText_ondblclickeffect_Description"));
            ...
            prop_onfocus.setDisplayName(resources.getString("SelectInputText_onfocus_DisplayName"));
            prop_onfocus.setShortDescription(resources.getString("SelectInputText_onfocus_Description"));
            ...
            prop_onkeydown.setDisplayName(resources.getString("SelectInputText_onkeydown_DisplayName"));
            prop_onkeydown.setShortDescription(resources.getString("SelectInputText_onkeydown_Description"));
            ...
            prop_onkeydowneffect.setDisplayName(resources.getString("SelectInputText_onkeydowneffect_DisplayName"));
            prop_onkeydowneffect.setShortDescription(resources.getString("SelectInputText_onkeydowneffect_Description"));
            ...
            prop_onkeypress.setDisplayName(resources.getString("SelectInputText_onkeypress_DisplayName"));
            prop_onkeypress.setShortDescription(resources.getString("SelectInputText_onkeypress_Description"));
            ...
            prop_onkeypresseffect.setDisplayName(resources.getString("SelectInputText_onkeypresseffect_DisplayName"));
            prop_onkeypresseffect.setShortDescription(resources.getString("SelectInputText_onkeypresseffect_Description"));
            ...
            prop_onkeyup.setDisplayName(resources.getString("SelectInputText_onkeyup_DisplayName"));
            prop_onkeyup.setShortDescription(resources.getString("SelectInputText_onkeyup_Description"));
            ...
            prop_onkeyupeffect.setDisplayName(resources.getString("SelectInputText_onkeyupeffect_DisplayName"));
            prop_onkeyupeffect.setShortDescription(resources.getString("SelectInputText_onkeyupeffect_Description"));
            ...
            prop_onmousedown.setDisplayName(resources.getString("SelectInputText_onmousedown_DisplayName"));
            prop_onmousedown.setShortDescription(resources.getString("SelectInputText_onmousedown_Description"));
            ...
            prop_onmousedowneffect.setDisplayName(resources.getString("SelectInputText_onmousedowneffect_DisplayName"));
            prop_onmousedowneffect.setShortDescription(resources.getString("SelectInputText_onmousedowneffect_Description"));
            ...
            prop_onmousemove.setDisplayName(resources.getString("SelectInputText_onmousemove_DisplayName"));
            prop_onmousemove.setShortDescription(resources.getString("SelectInputText_onmousemove_Description"));
            ...
            prop_onmousemoveeffect.setDisplayName(resources.getString("SelectInputText_onmousemoveeffect_DisplayName"));
            prop_onmousemoveeffect.setShortDescription(resources.getString("SelectInputText_onmousemoveeffect_Description"));
            ...
            prop_onmouseout.setDisplayName(resources.getString("SelectInputText_onmouseout_DisplayName"));
            prop_onmouseout.setShortDescription(resources.getString("SelectInputText_onmouseout_Description"));
            ...
            prop_onmouseouteffect.setDisplayName(resources.getString("SelectInputText_onmouseouteffect_DisplayName"));
            prop_onmouseouteffect.setShortDescription(resources.getString("SelectInputText_onmouseouteffect_Description"));
            ...
            prop_onmouseover.setDisplayName(resources.getString("SelectInputText_onmouseover_DisplayName"));
            prop_onmouseover.setShortDescription(resources.getString("SelectInputText_onmouseover_Description"));
            ...
            prop_onmouseovereffect.setDisplayName(resources.getString("SelectInputText_onmouseovereffect_DisplayName"));
            prop_onmouseovereffect.setShortDescription(resources.getString("SelectInputText_onmouseovereffect_Description"));
            ...
            prop_onmouseup.setDisplayName(resources.getString("SelectInputText_onmouseup_DisplayName"));
            prop_onmouseup.setShortDescription(resources.getString("SelectInputText_onmouseup_Description"));
            ...
            prop_onmouseupeffect.setDisplayName(resources.getString("SelectInputText_onmouseupeffect_DisplayName"));
            prop_onmouseupeffect.setShortDescription(resources.getString("SelectInputText_onmouseupeffect_Description"));
            ...
            prop_onselect.setDisplayName(resources.getString("SelectInputText_onselect_DisplayName"));
            prop_onselect.setShortDescription(resources.getString("SelectInputText_onselect_Description"));
            ...
            prop_options.setDisplayName(resources.getString("SelectInputText_options_DisplayName"));
            prop_options.setShortDescription(resources.getString("SelectInputText_options_Description"));
            prop_options.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.propertyeditors.StringPropertyEditor"));
            ...
            prop_options.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.ADVANCED);

            PropertyDescriptor prop_partialSubmit = new PropertyDescriptor("partialSubmit",beanClass,"isPartialSubmit","setPartialSubmit");
            prop_partialSubmit.setDisplayName(resources.getString("SelectInputText_partialSubmit_DisplayName"));
            prop_partialSubmit.setShortDescription(resources.getString("SelectInputText_partialSubmit_Description"));
            ...
            prop_readonly.setDisplayName(resources.getString("SelectInputText_readonly_DisplayName"));
            prop_readonly.setShortDescription(resources.getString("SelectInputText_readonly_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("SelectInputText_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("SelectInputText_rendered_Description"));
            ...
            prop_renderedOnUserRole.setDisplayName(resources.getString("SelectInputText_renderedOnUserRole_DisplayName"));
            prop_renderedOnUserRole.setShortDescription(resources.getString("SelectInputText_renderedOnUserRole_Description"));
            ...
            prop_required.setDisplayName(resources.getString("SelectInputText_required_DisplayName"));
            prop_required.setShortDescription(resources.getString("SelectInputText_required_Description"));
            ...
            prop_requiredMessage.setDisplayName(resources.getString("SelectInputText_requiredMessage_DisplayName"));
            prop_requiredMessage.setShortDescription(resources.getString("SelectInputText_requiredMessage_Description"));
            ...
            prop_rows.setDisplayName(resources.getString("SelectInputText_rows_DisplayName"));
            prop_rows.setShortDescription(resources.getString("SelectInputText_rows_Description"));
            ...
            attrib = new AttributeDescriptor("rows",false,"10",true);
            prop_rows.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_rows.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.ICE_LAYOUT);

            PropertyDescriptor prop_size = new PropertyDescriptor("size",beanClass,"getSize","setSize");
            prop_size.setDisplayName(resources.getString("SelectInputText_size_DisplayName"));
            prop_size.setShortDescription(resources.getString("SelectInputText_size_Description"));
            ...
            prop_style.setDisplayName(resources.getString("SelectInputText_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("SelectInputText_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("SelectInputText_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("SelectInputText_styleClass_Description"));
            ...
            prop_tabindex.setDisplayName(resources.getString("SelectInputText_tabindex_DisplayName"));
            prop_tabindex.setShortDescription(resources.getString("SelectInputText_tabindex_Description"));
            ...
            PropertyDescriptor prop_textChangeListener = new PropertyDescriptor("textChangeListener",beanClass,"getTextChangeListener","setTextChangeListener");
            prop_textChangeListener.setDisplayName(resources.getString("SelectInputText_textChangeListener_DisplayName"));
            prop_textChangeListener.setShortDescription(resources.getString("SelectInputText_textChangeListener_Description"));
            prop_textChangeListener.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.propertyeditors.MethodBindingPropertyEditor"));
            prop_textChangeListener.setExpert(false);
            prop_textChangeListener.setHidden(false);
            prop_textChangeListener.setPreferred(false);
            attrib = new AttributeDescriptor("textChangeListener",false,null,true);
            prop_textChangeListener.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_textChangeListener.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.ADVANCED);

            PropertyDescriptor prop_title = new PropertyDescriptor("title",beanClass,"getTitle","setTitle");
            prop_title.setDisplayName(resources.getString("SelectInputText_title_DisplayName"));
            prop_title.setShortDescription(resources.getString("SelectInputText_title_Description"));
            ...
            prop_validator.setDisplayName(resources.getString("SelectInputText_validator_DisplayName"));
            prop_validator.setShortDescription(resources.getString("SelectInputText_validator_Description"));
            ...
            prop_value.setDisplayName(resources.getString("SelectInputText_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("SelectInputText_value_Description"));
            ...
            prop_valueChangeListener.setDisplayName(resources.getString("SelectInputText_valueChangeListener_DisplayName"));
            prop_valueChangeListener.setShortDescription(resources.getString("SelectInputText_valueChangeListener_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("SelectInputText_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("SelectInputText_visible_Description"));
            ...
            prop_width.setDisplayName(resources.getString("SelectInputText_width_DisplayName"));
            prop_width.setShortDescription(resources.getString("SelectInputText_width_Description"));
            ...
            attrib = new AttributeDescriptor("width",false,"\"150\"",true);
            ...
            prop_attributes.setDisplayName(resources.getString("SelectInputText_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("SelectInputText_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("SelectInputText_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("SelectInputText_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("SelectInputText_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("SelectInputText_children_Description"));
            ...
            prop_converterMessage.setDisplayName(resources.getString("SelectInputText_converterMessage_DisplayName"));
            prop_converterMessage.setShortDescription(resources.getString("SelectInputText_converterMessage_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("SelectInputText_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("SelectInputText_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("SelectInputText_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("SelectInputText_family_Description"));
            ...
            prop_label.setDisplayName(resources.getString("SelectInputText_label_DisplayName"));
            prop_label.setShortDescription(resources.getString("SelectInputText_label_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("SelectInputText_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("SelectInputText_localValue_Description"));
            ...
            prop_localValueSet.setDisplayName(resources.getString("SelectInputText_localValueSet_DisplayName"));
            prop_localValueSet.setShortDescription(resources.getString("SelectInputText_localValueSet_Description"));
            ...
            prop_onblur.setDisplayName(resources.getString("SelectInputText_onblur_DisplayName"));
            prop_onblur.setShortDescription(resources.getString("SelectInputText_onblur_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("SelectInputText_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("SelectInputText_parent_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("SelectInputText_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("SelectInputText_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("SelectInputText_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("SelectInputText_rendersChildren_Description"));
            ...
            prop_submittedValue.setDisplayName(resources.getString("SelectInputText_submittedValue_DisplayName"));
            prop_submittedValue.setShortDescription(resources.getString("SelectInputText_submittedValue_Description"));
            ...
            prop_validatorMessage.setDisplayName(resources.getString("SelectInputText_validatorMessage_DisplayName"));
            prop_validatorMessage.setShortDescription(resources.getString("SelectInputText_validatorMessage_Description"));
