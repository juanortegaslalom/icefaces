...
abstract class CommandSortHeaderBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("com.icesoft.faces.component.commandsortheader.Bundle-JSF", Locale.getDefault(), CommandSortHeaderBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>CommandSortHeaderBeanInfoBase</code>.</p>
     */
    public CommandSortHeaderBeanInfoBase() {

        beanClass = CommandSortHeader.class;
        iconFileName_C16 = "CommandSortHeader_C16";
        iconFileName_C32 = "CommandSortHeader_C32";
        iconFileName_M16 = "CommandSortHeader_M16";
        iconFileName_M32 = "CommandSortHeader_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("CommandSortHeader_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("CommandSortHeader_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"commandSortHeader");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.MARKUP_SECTION,"form");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"commandSortHeader");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            PropertyDescriptor prop_arrow = new PropertyDescriptor("arrow",beanClass,"isArrow","setArrow");
            prop_arrow.setDisplayName(resources.getString("CommandSortHeader_arrow_DisplayName"));
            prop_arrow.setShortDescription(resources.getString("CommandSortHeader_arrow_Description"));
            prop_arrow.setExpert(false);
            prop_arrow.setHidden(false);
            prop_arrow.setPreferred(false);
            attrib = new AttributeDescriptor("arrow",false,null,true);
            prop_arrow.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_arrow.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.ICE_LAYOUT);

            PropertyDescriptor prop_columnName = new PropertyDescriptor("columnName",beanClass,"getColumnName","setColumnName");
            prop_columnName.setDisplayName(resources.getString("CommandSortHeader_columnName_DisplayName"));
            prop_columnName.setShortDescription(resources.getString("CommandSortHeader_columnName_Description"));
            prop_columnName.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.propertyeditors.StringPropertyEditor"));
            prop_columnName.setExpert(false);
            prop_columnName.setHidden(false);
            prop_columnName.setPreferred(false);
            attrib = new AttributeDescriptor("columnName",false,null,true);
            prop_columnName.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_columnName.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.ICE_LAYOUT);

            PropertyDescriptor prop_disabled = new PropertyDescriptor("disabled",beanClass,"isDisabled","setDisabled");
            prop_disabled.setDisplayName(resources.getString("CommandSortHeader_disabled_DisplayName"));
            prop_disabled.setShortDescription(resources.getString("CommandSortHeader_disabled_Description"));
            ...
            prop_enabledOnUserRole.setDisplayName(resources.getString("CommandSortHeader_enabledOnUserRole_DisplayName"));
            prop_enabledOnUserRole.setShortDescription(resources.getString("CommandSortHeader_enabledOnUserRole_Description"));
            ...
            prop_id.setDisplayName(resources.getString("CommandSortHeader_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("CommandSortHeader_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("CommandSortHeader_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("CommandSortHeader_immediate_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("CommandSortHeader_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("CommandSortHeader_rendered_Description"));
            ...
            prop_renderedOnUserRole.setDisplayName(resources.getString("CommandSortHeader_renderedOnUserRole_DisplayName"));
            prop_renderedOnUserRole.setShortDescription(resources.getString("CommandSortHeader_renderedOnUserRole_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("CommandSortHeader_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("CommandSortHeader_styleClass_Description"));
            ...
            prop_action.setDisplayName(resources.getString("CommandSortHeader_action_DisplayName"));
            prop_action.setShortDescription(resources.getString("CommandSortHeader_action_Description"));
            prop_action.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.propertyeditors.MethodBindingPropertyEditor"));
            ...
            prop_action.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.ADVANCED);
            ...
            prop_actionListener.setDisplayName(resources.getString("CommandSortHeader_actionListener_DisplayName"));
            prop_actionListener.setShortDescription(resources.getString("CommandSortHeader_actionListener_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("CommandSortHeader_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("CommandSortHeader_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("CommandSortHeader_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("CommandSortHeader_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("CommandSortHeader_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("CommandSortHeader_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("CommandSortHeader_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("CommandSortHeader_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("CommandSortHeader_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("CommandSortHeader_family_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("CommandSortHeader_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("CommandSortHeader_parent_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("CommandSortHeader_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("CommandSortHeader_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("CommandSortHeader_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("CommandSortHeader_rendersChildren_Description"));
            ...
            prop_value.setDisplayName(resources.getString("CommandSortHeader_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("CommandSortHeader_value_Description"));
