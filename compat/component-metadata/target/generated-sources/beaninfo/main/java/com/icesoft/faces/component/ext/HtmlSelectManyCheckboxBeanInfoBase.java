...
abstract class HtmlSelectManyCheckboxBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("com.icesoft.faces.component.ext.Bundle-JSF", Locale.getDefault(), HtmlSelectManyCheckboxBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>HtmlSelectManyCheckboxBeanInfoBase</code>.</p>
     */
    public HtmlSelectManyCheckboxBeanInfoBase() {

        beanClass = HtmlSelectManyCheckbox.class;
        iconFileName_C16 = "HtmlSelectManyCheckbox_C16";
        iconFileName_C32 = "HtmlSelectManyCheckbox_C32";
        iconFileName_M16 = "HtmlSelectManyCheckbox_M16";
        iconFileName_M32 = "HtmlSelectManyCheckbox_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"selectManyCheckbox");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_autocomplete.setDisplayName(resources.getString("HtmlSelectManyCheckbox_autocomplete_DisplayName"));
            prop_autocomplete.setShortDescription(resources.getString("HtmlSelectManyCheckbox_autocomplete_Description"));
            ...
            prop_converter.setDisplayName(resources.getString("HtmlSelectManyCheckbox_converter_DisplayName"));
            prop_converter.setShortDescription(resources.getString("HtmlSelectManyCheckbox_converter_Description"));
            ...
            prop_dir.setDisplayName(resources.getString("HtmlSelectManyCheckbox_dir_DisplayName"));
            prop_dir.setShortDescription(resources.getString("HtmlSelectManyCheckbox_dir_Description"));
            ...
            prop_effect.setDisplayName(resources.getString("HtmlSelectManyCheckbox_effect_DisplayName"));
            prop_effect.setShortDescription(resources.getString("HtmlSelectManyCheckbox_effect_Description"));
            ...
            prop_enabledOnUserRole.setDisplayName(resources.getString("HtmlSelectManyCheckbox_enabledOnUserRole_DisplayName"));
            prop_enabledOnUserRole.setShortDescription(resources.getString("HtmlSelectManyCheckbox_enabledOnUserRole_Description"));
            ...
            prop_id.setDisplayName(resources.getString("HtmlSelectManyCheckbox_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("HtmlSelectManyCheckbox_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("HtmlSelectManyCheckbox_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("HtmlSelectManyCheckbox_immediate_Description"));
            ...
            prop_lang.setDisplayName(resources.getString("HtmlSelectManyCheckbox_lang_DisplayName"));
            prop_lang.setShortDescription(resources.getString("HtmlSelectManyCheckbox_lang_Description"));
            ...
            prop_layout.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.propertyeditors.SelectOneDomainEditor"));
            prop_layout.setExpert(false);
            prop_layout.setHidden(false);
            prop_layout.setPreferred(false);
            attrib = new AttributeDescriptor("layout",false,"lineDirection",true);
            ...
            prop_layout.setValue("com.sun.rave.propertyeditors.DOMAIN_CLASS", com.sun.rave.propertyeditors.domains.LayoutDomain.class);

            PropertyDescriptor prop_onblur = new PropertyDescriptor("onblur",beanClass,"getOnblur","setOnblur");
            prop_onblur.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onblur_DisplayName"));
            prop_onblur.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onblur_Description"));
            ...
            prop_onchange.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onchange_DisplayName"));
            prop_onchange.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onchange_Description"));
            ...
            prop_onclick.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onclick_DisplayName"));
            prop_onclick.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onclick_Description"));
            ...
            prop_onclickeffect.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onclickeffect_DisplayName"));
            prop_onclickeffect.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onclickeffect_Description"));
            ...
            prop_ondblclick.setDisplayName(resources.getString("HtmlSelectManyCheckbox_ondblclick_DisplayName"));
            prop_ondblclick.setShortDescription(resources.getString("HtmlSelectManyCheckbox_ondblclick_Description"));
            ...
            prop_ondblclickeffect.setDisplayName(resources.getString("HtmlSelectManyCheckbox_ondblclickeffect_DisplayName"));
            prop_ondblclickeffect.setShortDescription(resources.getString("HtmlSelectManyCheckbox_ondblclickeffect_Description"));
            ...
            prop_onfocus.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onfocus_DisplayName"));
            prop_onfocus.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onfocus_Description"));
            ...
            prop_onkeydown.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onkeydown_DisplayName"));
            prop_onkeydown.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onkeydown_Description"));
            ...
            prop_onkeydowneffect.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onkeydowneffect_DisplayName"));
            prop_onkeydowneffect.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onkeydowneffect_Description"));
            ...
            prop_onkeypress.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onkeypress_DisplayName"));
            prop_onkeypress.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onkeypress_Description"));
            ...
            attrib = new AttributeDescriptor("onkeypress",false,"\"Ice.util.radioCheckboxEnter(form,this,event);\"",true);
            ...
            prop_onkeypresseffect.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onkeypresseffect_DisplayName"));
            prop_onkeypresseffect.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onkeypresseffect_Description"));
            ...
            prop_onkeyup.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onkeyup_DisplayName"));
            prop_onkeyup.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onkeyup_Description"));
            ...
            prop_onkeyupeffect.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onkeyupeffect_DisplayName"));
            prop_onkeyupeffect.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onkeyupeffect_Description"));
            ...
            prop_onmousedown.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onmousedown_DisplayName"));
            prop_onmousedown.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onmousedown_Description"));
            ...
            prop_onmousedowneffect.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onmousedowneffect_DisplayName"));
            prop_onmousedowneffect.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onmousedowneffect_Description"));
            ...
            prop_onmousemove.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onmousemove_DisplayName"));
            prop_onmousemove.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onmousemove_Description"));
            ...
            prop_onmousemoveeffect.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onmousemoveeffect_DisplayName"));
            prop_onmousemoveeffect.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onmousemoveeffect_Description"));
            ...
            prop_onmouseout.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onmouseout_DisplayName"));
            prop_onmouseout.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onmouseout_Description"));
            ...
            prop_onmouseouteffect.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onmouseouteffect_DisplayName"));
            prop_onmouseouteffect.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onmouseouteffect_Description"));
            ...
            prop_onmouseover.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onmouseover_DisplayName"));
            prop_onmouseover.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onmouseover_Description"));
            ...
            prop_onmouseovereffect.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onmouseovereffect_DisplayName"));
            prop_onmouseovereffect.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onmouseovereffect_Description"));
            ...
            prop_onmouseup.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onmouseup_DisplayName"));
            prop_onmouseup.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onmouseup_Description"));
            ...
            prop_onmouseupeffect.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onmouseupeffect_DisplayName"));
            prop_onmouseupeffect.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onmouseupeffect_Description"));
            ...
            prop_partialSubmit.setDisplayName(resources.getString("HtmlSelectManyCheckbox_partialSubmit_DisplayName"));
            prop_partialSubmit.setShortDescription(resources.getString("HtmlSelectManyCheckbox_partialSubmit_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("HtmlSelectManyCheckbox_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("HtmlSelectManyCheckbox_rendered_Description"));
            ...
            prop_renderedOnUserRole.setDisplayName(resources.getString("HtmlSelectManyCheckbox_renderedOnUserRole_DisplayName"));
            prop_renderedOnUserRole.setShortDescription(resources.getString("HtmlSelectManyCheckbox_renderedOnUserRole_Description"));
            ...
            prop_required.setDisplayName(resources.getString("HtmlSelectManyCheckbox_required_DisplayName"));
            prop_required.setShortDescription(resources.getString("HtmlSelectManyCheckbox_required_Description"));
            ...
            prop_requiredMessage.setDisplayName(resources.getString("HtmlSelectManyCheckbox_requiredMessage_DisplayName"));
            prop_requiredMessage.setShortDescription(resources.getString("HtmlSelectManyCheckbox_requiredMessage_Description"));
            ...
            prop_style.setDisplayName(resources.getString("HtmlSelectManyCheckbox_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("HtmlSelectManyCheckbox_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("HtmlSelectManyCheckbox_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("HtmlSelectManyCheckbox_styleClass_Description"));
            ...
            prop_title.setDisplayName(resources.getString("HtmlSelectManyCheckbox_title_DisplayName"));
            prop_title.setShortDescription(resources.getString("HtmlSelectManyCheckbox_title_Description"));
            ...
            prop_validator.setDisplayName(resources.getString("HtmlSelectManyCheckbox_validator_DisplayName"));
            prop_validator.setShortDescription(resources.getString("HtmlSelectManyCheckbox_validator_Description"));
            ...
            prop_value.setDisplayName(resources.getString("HtmlSelectManyCheckbox_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("HtmlSelectManyCheckbox_value_Description"));
            ...
            prop_valueChangeListener.setDisplayName(resources.getString("HtmlSelectManyCheckbox_valueChangeListener_DisplayName"));
            prop_valueChangeListener.setShortDescription(resources.getString("HtmlSelectManyCheckbox_valueChangeListener_Description"));
            ...
            prop_visible.setDisplayName(resources.getString("HtmlSelectManyCheckbox_visible_DisplayName"));
            prop_visible.setShortDescription(resources.getString("HtmlSelectManyCheckbox_visible_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("HtmlSelectManyCheckbox_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("HtmlSelectManyCheckbox_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("HtmlSelectManyCheckbox_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("HtmlSelectManyCheckbox_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("HtmlSelectManyCheckbox_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("HtmlSelectManyCheckbox_children_Description"));
            ...
            prop_converterMessage.setDisplayName(resources.getString("HtmlSelectManyCheckbox_converterMessage_DisplayName"));
            prop_converterMessage.setShortDescription(resources.getString("HtmlSelectManyCheckbox_converterMessage_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("HtmlSelectManyCheckbox_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("HtmlSelectManyCheckbox_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("HtmlSelectManyCheckbox_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("HtmlSelectManyCheckbox_family_Description"));
            ...
            prop_label.setDisplayName(resources.getString("HtmlSelectManyCheckbox_label_DisplayName"));
            prop_label.setShortDescription(resources.getString("HtmlSelectManyCheckbox_label_Description"));
            ...
            prop_localValue.setDisplayName(resources.getString("HtmlSelectManyCheckbox_localValue_DisplayName"));
            prop_localValue.setShortDescription(resources.getString("HtmlSelectManyCheckbox_localValue_Description"));
            ...
            prop_localValueSet.setDisplayName(resources.getString("HtmlSelectManyCheckbox_localValueSet_DisplayName"));
            prop_localValueSet.setShortDescription(resources.getString("HtmlSelectManyCheckbox_localValueSet_Description"));
            ...
            prop_onselect.setDisplayName(resources.getString("HtmlSelectManyCheckbox_onselect_DisplayName"));
            prop_onselect.setShortDescription(resources.getString("HtmlSelectManyCheckbox_onselect_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("HtmlSelectManyCheckbox_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("HtmlSelectManyCheckbox_parent_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("HtmlSelectManyCheckbox_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("HtmlSelectManyCheckbox_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("HtmlSelectManyCheckbox_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("HtmlSelectManyCheckbox_rendersChildren_Description"));
            ...
            prop_selectedClass.setDisplayName(resources.getString("HtmlSelectManyCheckbox_selectedClass_DisplayName"));
            prop_selectedClass.setShortDescription(resources.getString("HtmlSelectManyCheckbox_selectedClass_Description"));
            ...
            prop_selectedClass.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.GENERAL);

            PropertyDescriptor prop_selectedValues = new PropertyDescriptor("selectedValues",beanClass,"getSelectedValues","setSelectedValues");
            ...
            prop_selectedValues.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.DATA);
            ...
            prop_submittedValue.setDisplayName(resources.getString("HtmlSelectManyCheckbox_submittedValue_DisplayName"));
            prop_submittedValue.setShortDescription(resources.getString("HtmlSelectManyCheckbox_submittedValue_Description"));
            ...
            PropertyDescriptor prop_unselectedClass = new PropertyDescriptor("unselectedClass",beanClass,"getUnselectedClass","setUnselectedClass");
            prop_unselectedClass.setDisplayName(resources.getString("HtmlSelectManyCheckbox_unselectedClass_DisplayName"));
            prop_unselectedClass.setShortDescription(resources.getString("HtmlSelectManyCheckbox_unselectedClass_Description"));
            prop_unselectedClass.setExpert(false);
            prop_unselectedClass.setHidden(false);
            prop_unselectedClass.setPreferred(false);
            attrib = new AttributeDescriptor("unselectedClass",false,null,true);
            prop_unselectedClass.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_unselectedClass.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.GENERAL);
            ...
            prop_validatorMessage.setDisplayName(resources.getString("HtmlSelectManyCheckbox_validatorMessage_DisplayName"));
            prop_validatorMessage.setShortDescription(resources.getString("HtmlSelectManyCheckbox_validatorMessage_Description"));
