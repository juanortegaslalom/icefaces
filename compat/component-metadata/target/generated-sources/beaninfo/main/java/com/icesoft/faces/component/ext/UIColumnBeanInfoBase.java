...
abstract class UIColumnBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("com.icesoft.faces.component.ext.Bundle-JSF", Locale.getDefault(), UIColumnBeanInfoBase.class.getClassLoader());
    ...
    public UIColumnBeanInfoBase() {
        ...
        iconFileName_C16 = "UIColumn_C16";
        iconFileName_C32 = "UIColumn_C32";
        iconFileName_M16 = "UIColumn_M16";
        iconFileName_M32 = "UIColumn_M32";
    ...
    public FacetDescriptor[] getFacetDescriptors() {
        ...
        try {
            ...
            facet_footer.setDisplayName(resources.getString("UIColumn_footer_DisplayName"));
            facet_footer.setShortDescription(resources.getString("UIColumn_footer_Description"));

            FacetDescriptor facet_header = new FacetDescriptor("header");
            facet_header.setDisplayName(resources.getString("UIColumn_header_DisplayName"));
            facet_header.setShortDescription(resources.getString("UIColumn_header_Description"));
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_colspan.setDisplayName(resources.getString("UIColumn_colspan_DisplayName"));
            prop_colspan.setShortDescription(resources.getString("UIColumn_colspan_Description"));
            prop_colspan.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.propertyeditors.JavaScriptPropertyEditor"));
            ...
            prop_colspan.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.JAVASCRIPT);

            PropertyDescriptor prop_groupOn = new PropertyDescriptor("groupOn",beanClass,"getGroupOn","setGroupOn");
            prop_groupOn.setDisplayName(resources.getString("UIColumn_groupOn_DisplayName"));
            prop_groupOn.setShortDescription(resources.getString("UIColumn_groupOn_Description"));
            prop_groupOn.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.propertyeditors.StringPropertyEditor"));
            prop_groupOn.setExpert(false);
            prop_groupOn.setHidden(false);
            prop_groupOn.setPreferred(false);
            attrib = new AttributeDescriptor("groupOn",false,null,true);
            prop_groupOn.setValue(Constants.PropertyDescriptor.ATTRIBUTE_DESCRIPTOR,attrib);
            prop_groupOn.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.ADVANCED);
            ...
            prop_renderedOnUserRole.setDisplayName(resources.getString("UIColumn_renderedOnUserRole_DisplayName"));
            prop_renderedOnUserRole.setShortDescription(resources.getString("UIColumn_renderedOnUserRole_Description"));
            ...
            prop_rowspan.setDisplayName(resources.getString("UIColumn_rowspan_DisplayName"));
            prop_rowspan.setShortDescription(resources.getString("UIColumn_rowspan_Description"));
            prop_rowspan.setPropertyEditorClass(loadClass("org.netbeans.modules.visualweb.propertyeditors.JavaScriptPropertyEditor"));
            ...
            prop_rowspan.setValue(Constants.PropertyDescriptor.CATEGORY,com.icesoft.faces.ide.vwp.util.CategoryDescriptors.JAVASCRIPT);

            PropertyDescriptor prop_style = new PropertyDescriptor("style",beanClass,"getStyle","setStyle");
            prop_style.setDisplayName(resources.getString("UIColumn_style_DisplayName"));
            prop_style.setShortDescription(resources.getString("UIColumn_style_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("UIColumn_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("UIColumn_styleClass_Description"));
