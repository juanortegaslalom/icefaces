...
abstract class MenuItemSeparatorBeanInfoBase extends SimpleBeanInfo {

    protected static ResourceBundle resources = ResourceBundle.getBundle("com.icesoft.faces.component.menubar.Bundle-JSF", Locale.getDefault(), MenuItemSeparatorBeanInfoBase.class.getClassLoader());

    /**
     * <p>Construct a new <code>MenuItemSeparatorBeanInfoBase</code>.</p>
     */
    public MenuItemSeparatorBeanInfoBase() {

        beanClass = MenuItemSeparator.class;
        iconFileName_C16 = "MenuItemSeparator_C16";
        iconFileName_C32 = "MenuItemSeparator_C32";
        iconFileName_M16 = "MenuItemSeparator_M16";
        iconFileName_M32 = "MenuItemSeparator_M32";
    ...
    public BeanDescriptor getBeanDescriptor() {
        ...
        beanDescriptor.setDisplayName(resources.getString("MenuItemSeparator_DisplayName"));
        beanDescriptor.setShortDescription(resources.getString("MenuItemSeparator_Description"));
        beanDescriptor.setExpert(false);
        beanDescriptor.setHidden(false);
        beanDescriptor.setPreferred(false);
        beanDescriptor.setValue(Constants.BeanDescriptor.FACET_DESCRIPTORS,getFacetDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.INSTANCE_NAME,"menuItemSeparator");
        beanDescriptor.setValue(Constants.BeanDescriptor.IS_CONTAINER,Boolean.TRUE);
        beanDescriptor.setValue(Constants.BeanDescriptor.MARKUP_SECTION,"form");
        beanDescriptor.setValue(Constants.BeanDescriptor.PROPERTY_CATEGORIES,getCategoryDescriptors());
        beanDescriptor.setValue(Constants.BeanDescriptor.TAG_NAME,"menuItemSeparator");
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            prop_id.setDisplayName(resources.getString("MenuItemSeparator_id_DisplayName"));
            prop_id.setShortDescription(resources.getString("MenuItemSeparator_id_Description"));
            ...
            prop_immediate.setDisplayName(resources.getString("MenuItemSeparator_immediate_DisplayName"));
            prop_immediate.setShortDescription(resources.getString("MenuItemSeparator_immediate_Description"));
            ...
            prop_rendered.setDisplayName(resources.getString("MenuItemSeparator_rendered_DisplayName"));
            prop_rendered.setShortDescription(resources.getString("MenuItemSeparator_rendered_Description"));
            ...
            prop_styleClass.setDisplayName(resources.getString("MenuItemSeparator_styleClass_DisplayName"));
            prop_styleClass.setShortDescription(resources.getString("MenuItemSeparator_styleClass_Description"));
            ...
            prop_action.setDisplayName(resources.getString("MenuItemSeparator_action_DisplayName"));
            prop_action.setShortDescription(resources.getString("MenuItemSeparator_action_Description"));
            ...
            prop_actionListener.setDisplayName(resources.getString("MenuItemSeparator_actionListener_DisplayName"));
            prop_actionListener.setShortDescription(resources.getString("MenuItemSeparator_actionListener_Description"));
            ...
            prop_attributes.setDisplayName(resources.getString("MenuItemSeparator_attributes_DisplayName"));
            prop_attributes.setShortDescription(resources.getString("MenuItemSeparator_attributes_Description"));
            ...
            prop_childCount.setDisplayName(resources.getString("MenuItemSeparator_childCount_DisplayName"));
            prop_childCount.setShortDescription(resources.getString("MenuItemSeparator_childCount_Description"));
            ...
            prop_children.setDisplayName(resources.getString("MenuItemSeparator_children_DisplayName"));
            prop_children.setShortDescription(resources.getString("MenuItemSeparator_children_Description"));
            ...
            prop_facets.setDisplayName(resources.getString("MenuItemSeparator_facets_DisplayName"));
            prop_facets.setShortDescription(resources.getString("MenuItemSeparator_facets_Description"));
            ...
            prop_family.setDisplayName(resources.getString("MenuItemSeparator_family_DisplayName"));
            prop_family.setShortDescription(resources.getString("MenuItemSeparator_family_Description"));
            ...
            prop_parent.setDisplayName(resources.getString("MenuItemSeparator_parent_DisplayName"));
            prop_parent.setShortDescription(resources.getString("MenuItemSeparator_parent_Description"));
            ...
            prop_rendererType.setDisplayName(resources.getString("MenuItemSeparator_rendererType_DisplayName"));
            prop_rendererType.setShortDescription(resources.getString("MenuItemSeparator_rendererType_Description"));
            ...
            prop_rendersChildren.setDisplayName(resources.getString("MenuItemSeparator_rendersChildren_DisplayName"));
            prop_rendersChildren.setShortDescription(resources.getString("MenuItemSeparator_rendersChildren_Description"));
            ...
            prop_value.setDisplayName(resources.getString("MenuItemSeparator_value_DisplayName"));
            prop_value.setShortDescription(resources.getString("MenuItemSeparator_value_Description"));
