...
public class OutputLinkTag extends UIComponentTag {
        ...
        try{
            ...
            if (charset != null) {
                if (isValueReference(charset)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(charset));
            ...
            if (coords != null) {
                if (isValueReference(coords)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(coords));
            ...
            if (hreflang != null) {
                if (isValueReference(hreflang)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(hreflang));
            ...
            if (percentEncode != null) {
                if (isValueReference(percentEncode)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(percentEncode));
                    _component.setValueBinding("percentEncode", _vb);
                } else {
                    _component.getAttributes().put("percentEncode", Boolean.valueOf(percentEncode));
                }
            }
            if (rel != null) {
                if (isValueReference(rel)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(rel));
            ...
            if (rev != null) {
                if (isValueReference(rev)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(rev));
            ...
            if (shape != null) {
                if (isValueReference(shape)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(shape));
            ...
            if (fragment != null) {
                if (isValueReference(fragment)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(fragment));
                    _component.setValueBinding("fragment", _vb);
                } else {
                    _component.getAttributes().put("fragment", fragment);
                }
            }
    ...
    // percentEncode
    private String percentEncode = null;
    public void setPercentEncode(String percentEncode) {
