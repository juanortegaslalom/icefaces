    ...
    protected void setProperties(UIComponent _component) {
        try{
            ...
            if (panelConfirmation != null) {
                if (isValueReference(panelConfirmation)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(panelConfirmation));
                    _component.setValueBinding("panelConfirmation", _vb);
                } else {
                    _component.getAttributes().put("panelConfirmation", panelConfirmation);
                }
            }
