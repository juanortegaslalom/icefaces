...
public class MenuPopupTag extends UIComponentTag {
    ...
    protected void setProperties(UIComponent _component) {
        try{
            ...
            if (blockMenuOnInput != null) {
                if (isValueReference(blockMenuOnInput)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(blockMenuOnInput));
                    _component.setValueBinding("blockMenuOnInput", _vb);
                } else {
                    _component.getAttributes().put("blockMenuOnInput", Boolean.valueOf(blockMenuOnInput));
                }
            }
    ...
    // blockMenuOnInput
    private String blockMenuOnInput = null;
    public void setBlockMenuOnInput(String blockMenuOnInput) {
