...
public class SelectManyListboxTag extends UIComponentTag {
    ...
    public void release() {
        ...
        partialSubmit = null;
        partialSubmitDelay = null;
        partialSubmitOnBlur = null;
        readonly = null;
    ...
    protected void setProperties(UIComponent _component) {
        try{
            ...
            if (partialSubmitDelay != null) {
                if (isValueReference(partialSubmitDelay)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(partialSubmitDelay));
                    _component.setValueBinding("partialSubmitDelay", _vb);
                } else {
                    _component.getAttributes().put("partialSubmitDelay", Integer.valueOf(partialSubmitDelay));
                }
            }
            if (partialSubmitOnBlur != null) {
                if (isValueReference(partialSubmitOnBlur)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(partialSubmitOnBlur));
                    _component.setValueBinding("partialSubmitOnBlur", _vb);
                } else {
                    _component.getAttributes().put("partialSubmitOnBlur", Boolean.valueOf(partialSubmitOnBlur));
                }
            }
            if (readonly != null) {
    ...
    // partialSubmitDelay
    private String partialSubmitDelay = null;
    public void setPartialSubmitDelay(String partialSubmitDelay) {
        this.partialSubmitDelay = partialSubmitDelay;
    }

    // partialSubmitOnBlur
    private String partialSubmitOnBlur = null;
    public void setPartialSubmitOnBlur(String partialSubmitOnBlur) {
