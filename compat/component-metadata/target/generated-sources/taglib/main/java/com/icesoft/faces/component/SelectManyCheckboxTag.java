        ...
        try{
            ...
            if (unselectedClass != null) {
                if (isValueReference(unselectedClass)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(unselectedClass));
                    _component.setValueBinding("unselectedClass", _vb);
                } else {
                    _component.getAttributes().put("unselectedClass", unselectedClass);
                }
            }
