...
public class UIColumnsTag extends UIComponentTag {
    ...
    protected void setProperties(UIComponent _component) {
        try{
            ...
            if (_var != null) {
                try{
                    com.icesoft.faces.component.ext.UIColumns uicolumns = (com.icesoft.faces.component.ext.UIColumns)_component;
                    uicolumns.setVar(_var);
                }catch (ClassCastException cce) {
                    throw new IllegalStateException(_component.toString() + " not expected type.  Expected: com.icesoft.faces.component.ext.UIColumns.  Perhaps you're missing a tag?");
                }
            }
            if (varStatus != null) {
