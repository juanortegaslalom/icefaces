...
public class PanelDividerTag extends UIComponentTag {

    /**
     * <p>Return the requested component type.</p>
     */
    public String getComponentType() {
        return "com.icesoft.faces.PanelDivider";
    }
    ...
    public String getRendererType() {
        return "com.icesoft.faces.PanelDividerRenderer";
    }
    ...
    protected void setProperties(UIComponent _component) {
        try{
            ...
            if (dividerPosition != null) {
                if (isValueReference(dividerPosition)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(dividerPosition));
                    _component.setValueBinding("dividerPosition", _vb);
                } else {
                    _component.getAttributes().put("dividerPosition", Integer.valueOf(dividerPosition));
                }
            }
            if (orientation != null) {
    ...
    // dividerPosition
    private String dividerPosition = null;
