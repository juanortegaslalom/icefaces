...
public class GMapTag extends UIComponentTag {

    /**
     * <p>Return the requested component type.</p>
     */
    public String getComponentType() {
        return "com.icesoft.faces.GMap";
    }
    ...
    public String getRendererType() {
        return "com.icesoft.faces.GMapRenderer";
    }
    ...
    protected void setProperties(UIComponent _component) {
        try{
            ...
            if (address != null) {
                if (isValueReference(address)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(address));
                    _component.setValueBinding("address", _vb);
                } else {
                    _component.getAttributes().put("address", address);
                }
            }
            if (latitude != null) {
                if (isValueReference(latitude)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(latitude));
                    _component.setValueBinding("latitude", _vb);
                } else {
                    _component.getAttributes().put("latitude", latitude);
                }
            }
            ...
            if (longitude != null) {
                if (isValueReference(longitude)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(longitude));
                    _component.setValueBinding("longitude", _vb);
                } else {
                    _component.getAttributes().put("longitude", longitude);
                }
            }
            ...
            if (zoomLevel != null) {
                if (isValueReference(zoomLevel)) {
                    ValueBinding _vb = getFacesContext().getApplication().createValueBinding(ELPool.get(zoomLevel));
                    _component.setValueBinding("zoomLevel", _vb);
                } else {
                    _component.getAttributes().put("zoomLevel", Integer.valueOf(zoomLevel));
                }
            }
