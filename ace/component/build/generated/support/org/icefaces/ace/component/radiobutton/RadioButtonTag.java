 ...
 */
public class RadioButtonTag extends javax.faces.webapp.UIComponentELTag {
	public String getRendererType() {
		return "org.icefaces.ace.component.RadioButtonRenderer";
	}
	public String getComponentType() {
		return "org.icefaces.ace.component.RadioButton";
	}
	...
	protected void setProperties(UIComponent component) {
		...
		org.icefaces.ace.component.radiobutton.RadioButtonBase _component = null;
		try {
			_component = (org.icefaces.ace.component.radiobutton.RadioButtonBase) component;
		} catch (ClassCastException cce) {
			throw new IllegalStateException("Component " + component.toString() + " not expected type.  Expected:org.icefaces.ace.component.radiobutton.RadioButtonBase");
		}
		if (binding != null) {
