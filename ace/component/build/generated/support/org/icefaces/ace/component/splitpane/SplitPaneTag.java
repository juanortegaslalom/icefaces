 ...
 */
public class SplitPaneTag extends javax.faces.webapp.UIComponentELTag {
	public String getRendererType() {
		return "org.icefaces.SplitPaneRenderer";
	}
	...
	private javax.el.ValueExpression columnDivider;
	public void setColumnDivider(javax.el.ValueExpression columnDivider) {
	...
	protected void setProperties(UIComponent component) {
		...
		org.icefaces.ace.component.splitpane.SplitPaneBase _component = null;
		try {
			_component = (org.icefaces.ace.component.splitpane.SplitPaneBase) component;
		} catch (ClassCastException cce) {
			throw new IllegalStateException("Component " + component.toString() + " not expected type.  Expected:org.icefaces.ace.component.splitpane.SplitPaneBase");
		}
		if (binding != null) {
			_component.setValueExpression("binding", binding);
		}
		if (columnDivider != null) {
			_component.setValueExpression("columnDivider", columnDivider);
		}
		if (disabled != null) {
