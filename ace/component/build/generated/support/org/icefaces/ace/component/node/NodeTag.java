 ...
 */
public class NodeTag extends javax.faces.webapp.UIComponentELTag {
	public String getRendererType() {
		return null;
	}
	public String getComponentType() {
		return "org.icefaces.ace.component.Node";
	}
	...
	protected void setProperties(UIComponent component) {
		...
		org.icefaces.ace.component.node.NodeBase _component = null;
		try {
			_component = (org.icefaces.ace.component.node.NodeBase) component;
		} catch (ClassCastException cce) {
			throw new IllegalStateException("Component " + component.toString() + " not expected type.  Expected:org.icefaces.ace.component.node.NodeBase");
		}
		if (binding != null) {
