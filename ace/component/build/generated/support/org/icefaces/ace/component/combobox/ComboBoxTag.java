 ...
 */
public class ComboBoxTag extends javax.faces.webapp.UIComponentELTag {
	public String getRendererType() {
		return "org.icefaces.ace.component.ComboBoxRenderer";
	}
	public String getComponentType() {
		return "org.icefaces.ace.component.ComboBox";
	}
	...
	private javax.el.ValueExpression showListOnInput;
	public void setShowListOnInput(javax.el.ValueExpression showListOnInput) {
	...
	protected void setProperties(UIComponent component) {
		...
		org.icefaces.ace.component.combobox.ComboBoxBase _component = null;
		try {
			_component = (org.icefaces.ace.component.combobox.ComboBoxBase) component;
		} catch (ClassCastException cce) {
			throw new IllegalStateException("Component " + component.toString() + " not expected type.  Expected:org.icefaces.ace.component.combobox.ComboBoxBase");
		}
		if (accesskey != null) {
		...
		if (showListOnInput != null) {
			_component.setValueExpression("showListOnInput", showListOnInput);
		}
		if (size != null) {
