 ...
 */
public class LinkButtonTag extends javax.faces.webapp.UIComponentELTag {
	public String getRendererType() {
		return "org.icefaces.ace.component.LinkButtonRenderer";
	}
	public String getComponentType() {
		return "org.icefaces.ace.component.LinkButton";
	}
	...
	public void setHref(javax.el.ValueExpression href) {
		this.href = href;
	}
	...
	protected void setProperties(UIComponent component) {
		...
		org.icefaces.ace.component.linkbutton.LinkButtonBase _component = null;
		try {
			_component = (org.icefaces.ace.component.linkbutton.LinkButtonBase) component;
		} catch (ClassCastException cce) {
			throw new IllegalStateException("Component " + component.toString() + " not expected type.  Expected:org.icefaces.ace.component.linkbutton.LinkButtonBase");
		}
		if (action != null) {
		...
		if (href != null) {
			_component.setValueExpression("href", href);
		}
		if (hrefLang != null) {
			_component.setValueExpression("hrefLang", hrefLang);
		}
		if (id != null) {
