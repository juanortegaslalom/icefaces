 ...
 */
public class OutputListItemTag extends javax.faces.webapp.UIComponentELTag {
	public String getRendererType() {
		return "org.icefaces.OutputListItemRenderer";
	}
	...
	protected void setProperties(UIComponent component) {
		...
		org.icefaces.ace.component.outputlist.OutputListItemBase _component = null;
		try {
			_component = (org.icefaces.ace.component.outputlist.OutputListItemBase) component;
		} catch (ClassCastException cce) {
			throw new IllegalStateException("Component " + component.toString() + " not expected type.  Expected:org.icefaces.ace.component.outputlist.OutputListItemBase");
		}
		if (binding != null) {
