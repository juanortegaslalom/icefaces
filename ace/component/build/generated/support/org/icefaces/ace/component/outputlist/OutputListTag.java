 ...
 */
public class OutputListTag extends javax.faces.webapp.UIComponentELTag {
	public String getRendererType() {
		return "org.icefaces.OutputListRenderer";
	}
	...
	protected void setProperties(UIComponent component) {
		...
		org.icefaces.ace.component.outputlist.OutputListBase _component = null;
		try {
			_component = (org.icefaces.ace.component.outputlist.OutputListBase) component;
		} catch (ClassCastException cce) {
			throw new IllegalStateException("Component " + component.toString() + " not expected type.  Expected:org.icefaces.ace.component.outputlist.OutputListBase");
		}
		if (binding != null) {
