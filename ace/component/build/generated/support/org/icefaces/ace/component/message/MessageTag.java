 ...
 */
public class MessageTag extends javax.faces.webapp.UIComponentELTag {
	public String getRendererType() {
		return "org.icefaces.ace.component.MessageRenderer";
	}
	public String getComponentType() {
		return "org.icefaces.ace.component.Message";
	}
	...
	protected void setProperties(UIComponent component) {
		...
		org.icefaces.ace.component.message.MessageBase _component = null;
		try {
			_component = (org.icefaces.ace.component.message.MessageBase) component;
		} catch (ClassCastException cce) {
			throw new IllegalStateException("Component " + component.toString() + " not expected type.  Expected:org.icefaces.ace.component.message.MessageBase");
		}
		if (binding != null) {
