 ...
 */
public class QRCodeTag extends javax.faces.webapp.UIComponentELTag {
	public String getRendererType() {
		return "org.icefaces.QRCodeRenderer";
	}
	public String getComponentType() {
		return "org.icefaces.QRCode";
	}
	...
	protected void setProperties(UIComponent component) {
		...
		org.icefaces.ace.component.qrcode.QRCodeBase _component = null;
		try {
			_component = (org.icefaces.ace.component.qrcode.QRCodeBase) component;
		} catch (ClassCastException cce) {
			throw new IllegalStateException("Component " + component.toString() + " not expected type.  Expected:org.icefaces.ace.component.qrcode.QRCodeBase");
		}
		if (binding != null) {
