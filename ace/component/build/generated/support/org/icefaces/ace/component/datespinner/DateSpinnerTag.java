 ...
 */
public class DateSpinnerTag extends javax.faces.webapp.UIComponentELTag {
	public String getRendererType() {
		return "org.icefaces.component.DateSpinnerRenderer";
	}
	...
	private javax.el.ValueExpression yearEnd;
	public void setYearEnd(javax.el.ValueExpression yearEnd) {
		this.yearEnd = yearEnd;
	}
	private javax.el.ValueExpression yearStart;
	public void setYearStart(javax.el.ValueExpression yearStart) {
		this.yearStart = yearStart;
	}

	protected void setProperties(UIComponent component) {
		super.setProperties(component);
		org.icefaces.ace.component.datespinner.DateSpinnerBase _component = null;
		try {
			_component = (org.icefaces.ace.component.datespinner.DateSpinnerBase) component;
		} catch (ClassCastException cce) {
			throw new IllegalStateException("Component " + component.toString() + " not expected type.  Expected:org.icefaces.ace.component.datespinner.DateSpinnerBase");
		}
		if (binding != null) {
		...
		if (yearEnd != null) {
			_component.setValueExpression("yearEnd", yearEnd);
		}
		if (yearStart != null) {
			_component.setValueExpression("yearStart", yearStart);
		}
	}
