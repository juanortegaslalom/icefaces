 ...
 */
public class SubmenuTag extends javax.faces.webapp.UIComponentELTag {
	public String getRendererType() {
		return null;
	}
	public String getComponentType() {
		return "org.icefaces.ace.component.Submenu";
	}
	...
	protected void setProperties(UIComponent component) {
		...
		org.icefaces.ace.component.submenu.SubmenuBase _component = null;
		try {
			_component = (org.icefaces.ace.component.submenu.SubmenuBase) component;
		} catch (ClassCastException cce) {
			throw new IllegalStateException("Component " + component.toString() + " not expected type.  Expected:org.icefaces.ace.component.submenu.SubmenuBase");
		}
		if (binding != null) {
