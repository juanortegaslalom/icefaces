 ...
 */
public class TextEntryTag extends javax.faces.webapp.UIComponentELTag {
	public String getRendererType() {
		return "org.icefaces.ace.component.TextEntryRenderer";
	}
	public String getComponentType() {
		return "org.icefaces.ace.component.TextEntry";
	}
	...
	private javax.el.ValueExpression autoTab;
	public void setAutoTab(javax.el.ValueExpression autoTab) {
		this.autoTab = autoTab;
	}
	private javax.el.ValueExpression autocapitalize;
	public void setAutocapitalize(javax.el.ValueExpression autocapitalize) {
	...
	private javax.el.ValueExpression autocorrect;
	public void setAutocorrect(javax.el.ValueExpression autocorrect) {
	...
	private javax.el.ValueExpression step;
	public void setStep(javax.el.ValueExpression step) {
		this.step = step;
	}
	...
	protected void setProperties(UIComponent component) {
		...
		org.icefaces.ace.component.textentry.TextEntryBase _component = null;
		try {
			_component = (org.icefaces.ace.component.textentry.TextEntryBase) component;
		} catch (ClassCastException cce) {
			throw new IllegalStateException("Component " + component.toString() + " not expected type.  Expected:org.icefaces.ace.component.textentry.TextEntryBase");
		}
		if (accesskey != null) {
		...
		if (autoTab != null) {
			_component.setValueExpression("autoTab", autoTab);
		}
		if (autocapitalize != null) {
			_component.setValueExpression("autocapitalize", autocapitalize);
		}
		if (autocomplete != null) {
			_component.setValueExpression("autocomplete", autocomplete);
		}
		if (autocorrect != null) {
			_component.setValueExpression("autocorrect", autocorrect);
		}
		if (binding != null) {
		...
		if (step != null) {
			_component.setValueExpression("step", step);
		}
		if (style != null) {
