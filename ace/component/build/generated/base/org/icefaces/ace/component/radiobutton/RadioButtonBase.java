...
import org.icefaces.ace.component.radiobutton.IRadioButton;
...
public abstract class RadioButtonBase extends javax.faces.component.UISelectBoolean implements IRadioButton,IceClientBehaviorHolder{

	public static final String COMPONENT_TYPE = "org.icefaces.ace.component.RadioButton";
	public static final String RENDERER_TYPE = "org.icefaces.ace.component.RadioButtonRenderer";
	...
	public String getFamily() {
		return "org.icefaces.ace.RadioButton";
	}
	 ...
	 * <p>Contents: ID of button group component if this button is outside of the button group but wants to logically belong to the group.</p>
	 */
	public void setGroup(java.lang.String group) {
		...
		if (ve != null) {
			...
			if (isDisconnected(this))  {
				...
				Map clientDefaults = (Map) sh.get(defaultKey);
				if (clientDefaults == null && group != null) { 
					clientDefaults = new HashMap(); 
	 ...
	 * <p>Contents: Label to be displayed for the button.</p>
	 */
	 ...
	 * <p>Contents: Position of label relative to the radio button. Supported values are "left/right/top/bottom/none". Default is "none".</p>
	 */
 ...
 @Override
	...
	static {
		...
		lam.put("activate","");
		drm.put("deactivate","@all");
		dem.put("deactivate","@this");
		lam.put("deactivate","");
