...
import org.icefaces.ace.component.message.IMessage;
/*
 * ******* GENERATED CODE - DO NOT EDIT *******
 */

/**
 * The message tag renders the first Faces message (if redisplay is true) or the first undisplayed Faces message (if redisplay is false) for a specific component. Styling is done by predefined jQuery classes in theme stylesheets:<ul><li>Info: ui-icon-info w/ ui-state-highlight css</li><li>Warn: ui-icon-notice w/ ui-state-highlight css</li><li>Error: ui-icon-alert w/ ui-state-error css</li><li>Fatal: ui-icon-alert w/ ui-state-error css</li></ul>
 */
...
public abstract class MessageBase extends javax.faces.component.UIMessage implements IMessage{

	public static final String COMPONENT_TYPE = "org.icefaces.ace.component.Message";
	public static final String RENDERER_TYPE = "org.icefaces.ace.component.MessageRenderer";
	...
	public String getFamily() {
		return "org.icefaces.ace.Message";
	}
