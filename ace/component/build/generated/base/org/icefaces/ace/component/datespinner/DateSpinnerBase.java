package org.icefaces.ace.component.datespinner;
...
import org.icefaces.ace.component.datespinner.IDateSpinner;
...
@ResourceDependencies({
	...
	@ResourceDependency(name="datespinner.js",library="org.icefaces.component.datespinner",target="")
})

public abstract class DateSpinnerBase extends javax.faces.component.UIInput implements IDateSpinner,IceClientBehaviorHolder{

	public static final String COMPONENT_TYPE = "org.icefaces.component.DateSpinner";
	public static final String RENDERER_TYPE = "org.icefaces.component.DateSpinnerRenderer";

	private EnumSet<PropertyKeys> setOfUsedProperties = EnumSet.noneOf(PropertyKeys.class);

	public DateSpinnerBase() {
		super();
		setRendererType(RENDERER_TYPE);
	}

	public String getFamily() {
		return "org.icefaces.component.DateSpinner";
	}
	 ...
	 * <p>Contents: The DateFormat pattern.</p>
	 */
	 ...
	 * <p>Contents: The DateFormat pattern. Default = 'yyyy-MM-dd'.</p>
	 */
	public java.lang.String getPattern() {
		java.lang.String retVal = "yyyy-MM-dd";
		ValueExpression ve = getValueExpression( PropertyKeys.pattern.toString() );
		if (ve != null) {
	 ...
	 * <p>Contents: Width, in characters, of the input text field string containing the value of the selected date.</p>
	 */
	 ...
	 * <p>Contents: Width, in characters, of the input text field string containing the value of the selected date. Default = '15'.</p>
	 */
	 ...
	 * <p>Contents: A String or a java.util.TimeZone instance specify the timezone used for time conversion. Defaults to TimeZone.getDefault().</p>
	 */
	 ...
	 * <p>Contents: Determines if native date picker should be used when available.  Currently, native support is available for iOS5, iOS6, and BlackBerry devices.</p>
	 */
	 ...
	 * <p>Contents: Determines if native date picker should be used when available.  Currently, native support is available for iOS5, iOS6, and BlackBerry devices. Default = 'false'.</p>
	 */
	...
	/**
	 * <p>Set the value of the <code>yearEnd</code> property.</p>
	 * <p>Contents: The last year to appear in the dateScroller.</p>
	 */
	public void setYearEnd(int yearEnd) {
		PropertyKeys propToUse = PropertyKeys.yearEnd;
		addToSetOfUsedProperties(propToUse);
		ValueExpression ve = getValueExpression(PropertyKeys.yearEnd.toString() );
		if (ve != null) {
			// map of style values per clientId
			ve.setValue(getFacesContext().getELContext(), yearEnd );
		} else { 
			StateHelper sh = getStateHelper(); 
			if (isDisconnected(this))  {
				String defaultKey = PropertyKeys.yearEnd.toString() + "_defaultValues";
				Map clientDefaults = (Map) sh.get(defaultKey);
				if (clientDefaults == null) { 
					clientDefaults = new HashMap(); 
					clientDefaults.put("defValue",yearEnd);
					sh.put(defaultKey, clientDefaults); 
				} 
			} else {
				String clientId = getClientId();
				String valuesKey = PropertyKeys.yearEnd.toString() + "_rowValues"; 
				Map clientValues = (Map) sh.get(valuesKey); 
				if (clientValues == null) {
					clientValues = new HashMap(); 
				}
				clientValues.put(clientId, yearEnd);
				//Always re-add the delta values to the map. JSF merges the values into the main map
				//and values are not state saved unless they're in the delta map. 
				sh.put(valuesKey, clientValues);
			}
	...
	/**
	 * <p>Return the value of the <code>yearEnd</code> property.</p>
	 * <p>Contents: The last year to appear in the dateScroller. Default = '2020'.</p>
	 */
	public int getYearEnd() {
		java.lang.Integer retVal = 2020;
		ValueExpression ve = getValueExpression( PropertyKeys.yearEnd.toString() );
		if (ve != null) {
			Object o = ve.getValue( getFacesContext().getELContext() );
			if (o != null) { 
	...
	/**
	 * <p>Set the value of the <code>yearStart</code> property.</p>
	 * <p>Contents: The first year to appear in the dateScroller.</p>
	 */
	public void setYearStart(int yearStart) {
		PropertyKeys propToUse = PropertyKeys.yearStart;
		addToSetOfUsedProperties(propToUse);
		ValueExpression ve = getValueExpression(PropertyKeys.yearStart.toString() );
		if (ve != null) {
			// map of style values per clientId
			ve.setValue(getFacesContext().getELContext(), yearStart );
		} else { 
			StateHelper sh = getStateHelper(); 
			if (isDisconnected(this))  {
				String defaultKey = PropertyKeys.yearStart.toString() + "_defaultValues";
				Map clientDefaults = (Map) sh.get(defaultKey);
				if (clientDefaults == null) { 
					clientDefaults = new HashMap(); 
					clientDefaults.put("defValue",yearStart);
					sh.put(defaultKey, clientDefaults); 
				} 
			} else {
				String clientId = getClientId();
				String valuesKey = PropertyKeys.yearStart.toString() + "_rowValues"; 
				Map clientValues = (Map) sh.get(valuesKey); 
				if (clientValues == null) {
					clientValues = new HashMap(); 
				}
				clientValues.put(clientId, yearStart);
				//Always re-add the delta values to the map. JSF merges the values into the main map
				//and values are not state saved unless they're in the delta map. 
				sh.put(valuesKey, clientValues);
			}
	...
	/**
	 * <p>Return the value of the <code>yearStart</code> property.</p>
	 * <p>Contents: The first year to appear in the dateScroller. Default = '1980'.</p>
	 */
	public int getYearStart() {
		java.lang.Integer retVal = 1980;
		ValueExpression ve = getValueExpression( PropertyKeys.yearStart.toString() );
		if (ve != null) {
			Object o = ve.getValue( getFacesContext().getELContext() );
			if (o != null) { 
