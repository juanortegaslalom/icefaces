...
import org.icefaces.ace.component.outputlist.IOutputList;
/*
 * ******* GENERATED CODE - DO NOT EDIT *******
 */

/**
 * outputList defines a grouping of unordered list items.  The child component of this component must be outputListItem components. 
 */
...
public abstract class OutputListBase extends javax.faces.component.UIComponentBase implements IOutputList{

	public static final String COMPONENT_TYPE = "org.icefaces.OutputList";
	public static final String RENDERER_TYPE = "org.icefaces.OutputListRenderer";

	private EnumSet<PropertyKeys> setOfUsedProperties = EnumSet.noneOf(PropertyKeys.class);

	public OutputListBase() {
		super();
		setRendererType(RENDERER_TYPE);
	}

	public String getFamily() {
		return "org.icefaces.OutputList";
	}
	...
	/**
	 * <p>Set the value of the <code>inset</code> property.</p>
	 * <p>Contents: Determines if inset padding is applied around list group.</p>
	 */
	public void setInset(boolean inset) {
		PropertyKeys propToUse = PropertyKeys.inset;
		addToSetOfUsedProperties(propToUse);
		ValueExpression ve = getValueExpression(PropertyKeys.inset.toString() );
		if (ve != null) {
			// map of style values per clientId
			ve.setValue(getFacesContext().getELContext(), inset );
		} else { 
			StateHelper sh = getStateHelper(); 
			if (isDisconnected(this))  {
				String defaultKey = PropertyKeys.inset.toString() + "_defaultValues";
				Map clientDefaults = (Map) sh.get(defaultKey);
				if (clientDefaults == null) { 
					clientDefaults = new HashMap(); 
					clientDefaults.put("defValue",inset);
					sh.put(defaultKey, clientDefaults); 
				} 
			} else {
				String clientId = getClientId();
				String valuesKey = PropertyKeys.inset.toString() + "_rowValues"; 
				Map clientValues = (Map) sh.get(valuesKey); 
				if (clientValues == null) {
					clientValues = new HashMap(); 
				}
				clientValues.put(clientId, inset);
	...
	/**
	 * <p>Return the value of the <code>inset</code> property.</p>
	 * <p>Contents: Determines if inset padding is applied around list group. Default = 'false'.</p>
	 */
