...
import org.icefaces.ace.component.notificationpanel.INotificationPanel;
...
/**
 * The Notification Panel is a component that displays a multipurpose fixed positioned panel for notification. Any group of JSF content can be placed inside notification panel. If position of panel is out of place, try putting it as last child of body.<p>For more information, see the <a href="http://wiki.icefaces.org/display/ICE/NotificationPanel">NotificationPanel Wiki Documentation</a>.
 */
...
public abstract class NotificationPanelBase extends javax.faces.component.UIComponentBase implements INotificationPanel,IceClientBehaviorHolder{
	...
	public static final String COMPONENT_TYPE = "org.icefaces.ace.component.NotificationPanel";
	public static final String RENDERER_TYPE = "org.icefaces.ace.component.NotificationPanelRenderer";

	private EnumSet<PropertyKeys> setOfUsedProperties = EnumSet.noneOf(PropertyKeys.class);

	public NotificationPanelBase() {
		super();
	 ...
	 * <p>Contents: Name of the effect, "fade", "slide" or "none".</p>
	 */
	 ...
	 * <p>Contents: Name of the effect, "fade", "slide" or "none". Default = 'fade'.</p>
	 */
	...
	/**
	 * <p>Set the value of the <code>effectSpeed</code> property.</p>
	 * <p>Contents: Speed of the effect, "slow", "normal" or "fast".</p>
	 */
	public void setEffectSpeed(java.lang.String effectSpeed) {
		PropertyKeys propToUse = PropertyKeys.effectSpeed;
		addToSetOfUsedProperties(propToUse);
		ValueExpression ve = getValueExpression(PropertyKeys.effectSpeed.toString() );
		if (ve != null) {
			// map of style values per clientId
			ve.setValue(getFacesContext().getELContext(), effectSpeed );
		} else { 
			StateHelper sh = getStateHelper(); 
			if (isDisconnected(this))  {
				String defaultKey = PropertyKeys.effectSpeed.toString() + "_defaultValues";
				Map clientDefaults = (Map) sh.get(defaultKey);
				if (clientDefaults == null && effectSpeed != null) { 
					clientDefaults = new HashMap(); 
					clientDefaults.put("defValue",effectSpeed);
					sh.put(defaultKey, clientDefaults); 
				} 
			} else {
				String clientId = getClientId();
				String valuesKey = PropertyKeys.effectSpeed.toString() + "_rowValues"; 
				Map clientValues = (Map) sh.get(valuesKey); 
				if (clientValues == null) {
					clientValues = new HashMap(); 
				}
				if (effectSpeed == null) {
					...
					clientValues.put(clientId, effectSpeed);
				}
				//Always re-add the delta values to the map. JSF merges the values into the main map
				//and values are not state saved unless they're in the delta map. 
				sh.put(valuesKey, clientValues);
	...
	/**
	 * <p>Return the value of the <code>effectSpeed</code> property.</p>
	 * <p>Contents: Speed of the effect, "slow", "normal" or "fast". Default = 'normal'.</p>
	 */
	 ...
	 * <p>Contents: Position of the bar, "top" or "bottom".</p>
	 */
	 ...
	 * <p>Contents: Position of the bar, "top" or "bottom". Default = 'top'.</p>
	 */
	 ...
	 * <p>Contents: Style of the container element.</p>
	 */
	 ...
	 * <p>Contents: StyleClass of the container element.</p>
	 */
	 ...
	 * <p>Contents: Set visibility from the server</p>
	 */
	 ...
	 * <p>Contents: Set visibility from the server Default = 'false'.</p>
	 */
